...
export const normality = {
  samplingDistribution: doc.figure(
    ...
    'Sampling distributions of standardized estimators'
  ),
  estimatedVariance: doc.figure(
    ...
    //doc.span`Estimated Variance of β̂ⱼ${doc.br()}(asymptotic standard error)`,
    doc.span`Estimated Variance of β̂ⱼ`,
  ),
  asymptoticStdErr: doc.figure(
    ...
    'Asymptotic standard error of β̂_j'
  ),
};
