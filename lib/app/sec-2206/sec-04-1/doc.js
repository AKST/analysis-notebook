...
const { text, clsRef, infobox_2, dashbox, note, todo } = prelude.components;
...
export const consistency = createDoc(() => container(
  ...
  dashbox(
    ...
    twoThree(
      ...
      `,
      infobox_2({ title: 'Asymptotic Bias' })(doc.p`This is another name for inconsistency in an estimator such as 𝛽̂ⱼ`),
    ),
...
export const asymptoticNormality = createDoc(() => container(
  ...
  dashbox(
    ...
    twoThree(
      ...
      infobox_2({ title: 'asymptotic standard error' })(
        doc.p`
