...
export const predictionAndResidualAnalysis = createDoc(() => container(
  ...
  dashbox(
    twoThree(
      container(
        ...
        doc.p`
          ...
          error the prediction, we get obtaining that by recomputing our
          estimators after subtracting the variables used to obtain the
          prediction from the sample data and recomputing estimators for
          the model. The Intercept we end up in this new model will be
          our standard error.
        `,
      ),
      container(
        ...
        doc.dl(
          ...
          doc.dt`Prediction 95 Confindence Interval`,
          doc.dd.of(doc.small`
            Measure of prediction uncertainty. Put another way
            a confidence interval for the average value of y
            for the subpopulation with a given set of covariates.
          `),
          doc.dt`Prediction Interval`,
          doc.dd`
            A confidence interval for an unknown outcome for
            the dependent variable, which accounts for
    ...
    twoThree(
      container(
        doc.h4`Why is this the prediction SE?`,
        doc.p`
          The variance of the intercept estimator is
          smallest when each explanatory variable has
          zero sample mean. From this it follows that
          the variance of the prediction is smallest at
          the mean values of x${doc.sub`j`}.
        `,
      ),
      mathml.predictions.ci
    ),
    twoThree(
      container(
        doc.h4`Prediction Inverval`,
        doc.p`
