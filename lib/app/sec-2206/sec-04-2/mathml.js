...
const { SPECIAL, abs, annotationOver, rows: rows_2, parensA, call, table, eqId, eq, add, minus, div } = mathmlHelper_2;
      ...
      table.attr({ columnalign: 'right centre left' })(
        ...
        [
          ...
          add3(
            ...
            mul2(msub(SPECIAL.greek.circumflex.beta, mn(2)), msup(msub(mi`x`, mn(1)), mn(2)))
          ),
        ],
          ...
          mul2(
            parensA(
              add(
                ...
                mul2(mn(2), mul2(msub(SPECIAL.greek.circumflex.beta, mn(2)), msub(mi`x`, mn(1)))),
              )
            ),
            msub(mi`Δx`, mn(1))
          ),
    ...
    mathml.math(
      mrow(
        ...
        abs(
          mfrac(
            msub(SPECIAL.greek.circumflex.beta, mn(1)),
            mul2(mn(2), msub(SPECIAL.greek.circumflex.beta, mn(2)))
          )
        ),
      ),
    ),
      ...
      table.attr({ columnalign: 'right center left' })(
        ...
        [
          ...
          add3(
            ...
            mul2(msub(SPECIAL.greek.beta, mn(1)), call.attr({ fn: mtext`log` })(msub(mi`x`, mn(1)))),
            mul2(
      ...
      rows_2(
        mrow(
          ...
          add3(
            ...
            add(
              mul3(msub(SPECIAL.greek.beta, mn(3)), msub(mi`x`, mn(1)), msub(mi`x`, mn(2))),
              mi`u`
            )
          ),
        ),
        ...
        mrow(
          ...
          add(
            msub(SPECIAL.greek.beta, mn(2)),
            mul2(msub(SPECIAL.greek.beta, mn(3)), msub(mi`x`, mn(1)))
          ),
        ),
      )
    ),
      ...
      rows_2(
        mrow(
          ...
          add3(
            ...
            add3(
              mul2(msub(SPECIAL.greek.beta, mn(2)), msub(mi`x`, mn(2))),
              mul2(msub(SPECIAL.greek.beta, mn(3)), msup(msub(mi`x`, mn(1)), mn(2))),
              add(
                mul3(msub(SPECIAL.greek.beta, mn(4)), msub(mi`x`, mn(1)), msub(mi`x`, mn(2))),
                mi`u`
              )
            )
          ),
        ...
        mrow(
          ...
          add3(
            msub(SPECIAL.greek.beta, mn(1)),
            mul2(mn(2), mul2(msub(SPECIAL.greek.beta, mn(3)), msub(mi`x`, mn(1)))),
            mul2(msub(SPECIAL.greek.beta, mn(4)), msub(mi`x`, mn(2)))
          ),
        ),
        ...
        mrow(
          ...
          add3(
            msub(SPECIAL.greek.circumflex.beta, mn(1)),
            mul2(mn(2), mul2(msub(SPECIAL.greek.beta, mn(3)), msub(mi`x̄`, mn(1)))),
            mul2(msub(SPECIAL.greek.beta, mn(4)), msub(mi`x̄`, mn(2)))
          ),
        ),
      )
    ),
