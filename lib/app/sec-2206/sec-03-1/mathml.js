...
const { mi, mo, mtext, mrow, mn, msup, msub, msubsup, msqrt, munder } = mathml2;
  ...
  mathml2.math.attr({ style: 'font-size: 14px' })(
    rows(
      ...
      mrow(
        ...
        space(4), mo`∼`, space(4),
        call('Normal', mrow(mn(0), mo`,`, space(4), mn(1)))
      ),
      mrow(space(8)),
    )
  ),
...
export const degreesOfFreedom = doc.figure(
  mathml2.math(
    mrow(
      ...
      space(4), mo`∼`, space(4),
      msub(mi`t`, mrow(mi`n`, space(2), mo`−`, space(2), mi`k`, space(2), mo`−`, space(2), mn(1))),
      space(4), mo`=`, space(4),
      msub(mi`t`, mi`df`)
    )
  ),
  ...
  mathml2.math(
    rows(
      munder(
        ...
        munder(space(0), mtext`Hypothesis'`),
      ),
      space(8),
      mrow(
        munder(
          ...
          munder(space(0), mtext`H₀ rejection rule`),
        ),
        space(32),
        munder(
          mrow(
    ...
    table([
      [mi`F`, mo`=`, frac(
          ...
          [
            div(
              msub(mi`SSR`, mi`ur`),
              paren([mi`n`, space(4), mo`-`, space(4), mi`k`, space(4), mo`-`, space(4), mn(1)]),
            ),
          ]
      ), space(0), space(0)],
