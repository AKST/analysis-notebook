...
export const normality = doc._figure(
  mathml([
    rows([
      row([
...
export const samplingDistribution = doc._figure(
  mathml([
    rows([
      row([
...
export const classicalLinearModel = doc._figure(
  mathml([
    rows([
      row([
...
export const tDistributionOfEstimators = doc._figure(
  mathml([
    table([
      [
        i('A'),
...
export const degreesOfFreedom = doc._figure(
  mathml([
    row([
      frac(
        [
...
export const nullHypothesisOfBetaJ = doc._figure(
  mathml([
    row([
      sub(i('H'), n(0)),
      o(':'), space(4),
 ...
 */
export const hypothSet = (param, cons, thres, title, op) => doc._figure(
  mathml([
    rows([
      under(
        table([
...
export const tStatisticForBJ = doc._figure(
  mathml([
    eqId(
...
export const signficantLevel = doc._figure(
  mathml([
    row([
      SPECIAL.greek.alpha,
      space(4),
...
export const criticalValue = doc._figure(
  mathml([
    mathml.table([
      [
        sub(i('c'), i('lower')),
...
export const pValue = doc._figure(
...
export const tStatisticGeneral = doc._figure(
  mathml([
  ]),
  doc.figcaption`General t-statistic`
)

export const ci95 = doc._figure(
  mathml([
    mathml.table([
      [
        sub(SPECIAL.greek.circumflex.beta, i('j')),
...
export const jointHypothesisTest = doc._figure(
  mathml([
    mathml.table([
      [row([
        sub(i('H'), n(0)),
...
export const fStat = doc._figure(
  mathml([
    table([
      [i('F'), o('='), frac(
          [
...
export const fStatDistribution = doc._figure(
  mathml([
    mathml.row([
      i('F'),
      space(4),
...
export const fStatInTermsOfRSq = doc._figure(
  mathml([
    eq(
      eq(
        i('F'),
...
export const pValues = doc._figure(
  mathml([
    eq(
      mathml.text('p-value'),
      mathml.call(
