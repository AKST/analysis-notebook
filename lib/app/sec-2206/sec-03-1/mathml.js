...
export const fStat = doc.figure(
  mathml([
    mathml.rows([
      // Row 1: F ≡ ((SSR_r − SSR_ur)/q) / (SSR_ur / (n − k − 1))
      mathml.row([
        i('F'),
        space(4),
        o('≡'),
      ...
      // Row 2: q = numerator degrees of freedom = df_r − df_ur
      mathml.row([
        i('q'),
        space(4),
        o('='),
      ...
      // Row 3: n − k − 1 = denominator degrees of freedom = df_ur
      mathml.row([
        i('n'),
        space(4),
        o('-'),
...
export const fStatInTermsOfRSq = doc.figure(
  ...
  'F-statistic expressed using R² values for restricted and unrestricted models'
);
...
export const pValues = doc.figure(
  ...
  'right-tail probability under F_{q, n−k−1}'
)
