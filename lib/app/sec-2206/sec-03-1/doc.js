...
export const samplingDistribution = createDoc(() => dashbox(
  clsRef([3, 'W'], { k: 'slide', s: 3}, ['h2', 'Sampling Distribution of OLS Estimators']),
...
export const hypothesisTesting = createDoc(() => dashbox(
  ...
  twoColumns(
    container(
      clsRef([3, 'W'], { k: 'slide', s: 8 }, ['h4', 'General Hypothesis testing']),
      todo({}, 'notes from slide 8'),
    ),
    container(
      clsRef([3, 'W'], { k: 'slide', s: 9 }, ['h4', 'General Hypothesis testing']),
      todo({}, 'notes from slide 9'),
    ),
  ),
  clsRef([3, 'W'], { k: 'slide', s: 13 }, ['h3', 'The process']),
  twoThree(
    container(
      note(
...
export const significance = createDoc(() => dashbox(
  clsRef([3, 'W'], { k: 'slide', s: 20 }, ['h2', 'Significance']),
  twoThree(
    todo({}, 'notes'),
...
export const typeErrors = createDoc(() => dashbox(
  clsRef([3, 'W'], { k: 'slide', s: 21 }, ['h2', 'Type I & Type II Errors']),
  twoThree(
    todo({}, 'notes'),
    container(
      INFOBOX.type1Error,
...
const tDist = doc.b(['t', ['sub', 'N-K-1']]);
const tBetaJ = doc.b(['t', ['sub', ['β̂', ['sub', ['j']]]]]);

export const pValues = createDoc(() => dashbox(
  clsRef([3, 'W'], { k: 'slide', s: 22 }, ['h2', 'P Value']),
  note(
