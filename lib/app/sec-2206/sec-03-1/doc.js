...
export const hypothesisTestingTDist = createDoc(() => container(
  ...
  note(
    doc.span`t-distribution in Theorum 4.2, t-distribution${text.ul.compact.of(
...
export const pValues = createDoc(() => dashbox(
  ...
  twoColumns(
    text.ul.compact.of(
      doc.li`Big P-Value Bad ${text.ul.compact.of(
        doc.li`They provide evidence in favour of the H₀`,
      )}`,
      doc.li`Small P-Value Good ${text.ul.compact.of(
  ...
  container(
    twoColumns(
      container(
        ...
        text.ul.compact.of(
          doc.li`Do we have two seperate ways of testing hypothesis about a single coefficent?${text.ul.compact.of(
            doc.li`
