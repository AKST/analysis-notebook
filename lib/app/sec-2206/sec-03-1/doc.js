...
export const samplingDistribution = createDoc(() => dashbox(
  ...
  columns('2/3', [
    ...
    infobox_2({ title: 'First 2 Moments?' })(todo({}, 'describe what that means')),
  ]),
  columns('2/3', [
    doc.p`
    ...
    infobox_2({ title: 'Normality Assumption' })(
      todo({}, 'Do research on why this is acceptable and not some appeal to concequences'),
    ),
  ]),
  container(
    w3Ref({ page: 118 }, infobox_2({ title: 'MLR 6, Normality' })(
      doc.p`
  ...
  container(
    ...
    twoThree(
      doc.p`
        ...
        unrestricted models.
      `,
      infobox_2({ title: 'What is q?' })(doc.p`This is the number of exclusion restrictions`),
    ),
  ),
  container(
    ...
    twoThree(
      ...
      `,
      infobox_2({ title: 'When to use this?' })(
        doc.p`
