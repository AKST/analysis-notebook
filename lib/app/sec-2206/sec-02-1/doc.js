...
export const expectedOLSEstimatorsIrrelevantVars = createDoc(() => dashbox(
  ...
  twoColumns(
    container(
      clsRef([3, 'M'], { k: 'slide', s: 11 }, ['h4', 'No Perfect Collinearity']),
      note(
    ...
    container(
      clsRef([3, 'M'], { k: 'slide', s: 12 }, ['h4', 'Zero Conditional mean']),
      note(
  ...
  container(
    clsRef([3, 'M'], { k: 'slide', s: 13 }, ['h4', 'Exogenous And Endogenous Variables']),
    note(
  ...
  container(
    clsRef([3, 'M'], { k: 'slide', s: 13 }, ['h4', 'Endogenous Vs Exogenous']),
    note(
      doc.span('Exogenous', ulLight([
        'These are characterised by uncorrelatled variables',
        'Where Z is the variable E(U|X0...Xn) = E(Z|X0...Xn) = 0',
...
export const expectedOLSEstimatorsOmittedVariableBias = createDoc(() => dashbox(
  clsRef([3, 'M'], { k: 'slide', s: 3 }, ['h3', 'Omitted Variable Bias']),
  note(
  ...
  container(
    clsRef([3, 'M'], { k: 'slide', s: 5 }, ['h4', 'Measuring Correlations between Variables']),
    note(
      'Given X2 = D0 + D1X + W',
...
export const expectedOLSEstimatorsVariance = createDoc(() => dashbox(
  clsRef([3, 'M'], { k: 'slide', s: 14 }, ['h3', 'Variance of OLS Estimators']),
  note(),
  clsRef([3, 'M'], { k: 'slide', s: 15 }, ['h4', 'Components of OLS variance']),
  noteOn('Var(βᵢ)')(
...
export const expectedOLSEstimatorsMulticollinearity = createDoc(() => dashbox(
  clsRef([3, 'M'], { k: 'slide', s: 16 }, ['h3', 'Multicollinearity']),
  twoThree(
    note(
