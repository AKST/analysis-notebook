...
export const motivationForMultiRegression = createDoc(() => dashbox(
  ...
  container(
    twoThree(
      ...
      infobox_2({ title: 'Key Assumption' })(
  ...
  container(
    twoThree(
      ...
      infobox_2({ title: 'K convention' })(doc.p`k often denotes the number independent vars.`),
    ),
    doc.p`
          ...
          container(
            text.ul(
              ...
              doc.li`Understanding ${vars.RJ}, ${text.ul(
                ...
                doc.li`As R₂² gets closer to 1 Var(𝛽̂₂) gets larger:${text.ul(
...
export const varianceInMisspecifedModels = createDoc(() => dashbox(
  container(
    ...
    text.ul(
      doc.li`When 𝛽₂ = 0, 𝛽̃₁ and 𝛽̂₁ are both is unbiased and Var(𝛽̃₁) < Var(𝛽̂₁) ${text.ul(
        doc.li`In this case 𝛽̃₁ is preferable`,
      )}`,
      doc.li`When 𝛽₂ ≠ 0, 𝛽̃₁ is biased, 𝛽̂₁ is unbiased and Var(𝛽̃₁) < Var(𝛽̂₁) ${text.ul(
