...
export const motivationForMultiRegression = createDoc(() => dashbox(
  ...
  container(
    twoThree(
      ...
      infobox({ title: 'K convention' })(doc.p`k often denotes the number independent vars.`),
    ),
    doc.p`
