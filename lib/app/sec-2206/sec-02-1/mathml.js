...
const { mi, mo, mtext, mrow, mn, msup, msub, msubsup, msqrt } = mathml2;
    ...
    mathml2.math(
      rows(
        mrow(
          mo`{`, space(2),
          paren([
            msub(mi`x`, mrow(mi`i`, mn(1))), mo`,`, space(4),
            msub(mi`x`, mrow(mi`i`, mn(2))), mo`,`, space(4),
            msub(mi`y`, mi`i`)
          ]),
          space(6), mo`:`, space(6),
        ...
        mrow(
          ...
          space(8),
          msup(paren([
            msub(mi`y`, mi`i`), space(4), mo`-`, space(4),
            msub(SPECIAL.greek.circumflex.beta, mn(0)), space(4), mo`-`, space(4),
            mrow(
  ...
  regression: doc.figure(
    mathml2.math(
      eq(
        mi`y`,
        mrow(
          msub(mi`β`, mn(0)), space(4), mo`+`, space(4),
          msub(mi`β`, mn(1)), msub(mi`x`, mn(1)), space(4), mo`+`, space(4),
          msub(mi`β`, mn(2)), msub(mi`x`, mn(2)), space(4), mo`+`, space(4),
          msub(mi`β`, mn(3)), msub(mi`x`, mn(3)), space(4), mo`+`, space(4),
          SPECIAL.ellipse.h2, space(4), mo`+`, space(4),
          msub(mi`β`, mi`k`), msub(mi`x`, mi`k`), space(4), mo`+`, space(4),
          mi`u`
        )
      )
    ),
  ...
  estimate: doc.figure(
    mathml2.math(
      eq(
        mi`𝑦̂`,
        mrow(
          msub(mi`𝛽̂`, mn(0)), space(4), mo`+`, space(4),
          msub(mi`𝛽̂`, mn(1)), msub(mi`x`, mn(1)), space(4), mo`+`, space(4),
          msub(mi`𝛽̂`, mn(2)), msub(mi`x`, mn(2)), space(4), mo`+`, space(4),
          SPECIAL.ellipse.h2, space(4), mo`+`, space(4),
          msub(mi`𝛽̂`, mi`k`), msub(mi`x`, mi`k`), space(4)
        )
      )
    ),
    ...
    mathml2.math(
      eq(
        call(
          ...
          mrow(
            mi`u`, space(4), mo`|`, space(4),
            msub(mi`x`, mn(1)), space(4), mo`,`, space(4),
            msub(mi`x`, mn(2)), space(4), mo`,`, space(4),
            SPECIAL.ellipse.h2, space(4), mo`,`, space(4),
            msub(mi`x`, mi`k`)
          )
        ),
    ...
    mathml2.math(
      eq(
        call(
          ...
          frac(
            [msub(mi`P`, mi`i`)],
            [mrow(mn(1), space(4), mo`−`, space(4), msub(mi`P`, mi`i`))]
          )
        ),
        mrow(
          msub(mi`β`, mn(0)),
        ...
        add3(
          ...
          add(
            mul2(
              ...
              })(paren([minus(msub(mi`x`, mi`2i`), msub(mi`x̂`, mi`2i`))])),
            ),
...
export const varianceBiasComparison = {
  vif: doc.figure(
    mathml2.math(
      eq(
        ...
        frac(
          [mn(1)],
          [paren([mn(1), space(4), mo`-`, space(4), msup(msub(mi`R`, mi`j`), mn(2))])]
        )
      )
    ),
  ...
  var: doc.figure(
    mathml2.math(
      eq(
        ...
        frac(
          [msup(SPECIAL.greek.sigma, mn(2))],
          [msub(mi`SST`, mi`j`), paren([mn(1), space(4), mo`-`, space(4), msup(msub(mi`R`, mi`j`), mn(2))])]
        )
      )
    ),
  ...
  biasBeta1: doc.figure(
    mathml2.math(
      eq(
        call('Var', msub(mi`𝛽̃`, mn(1))),
        frac([msup(mi`𝜎`, mn(2))], [msub(mi`SST`, mn(1))])
      )
    ),
    ...
    mathml2.math(
      mathml.table([
        [
          ...
          mrow(
            msub(mi`y`, mi`i`),
            space(4), mo`-`, space(4), msub(SPECIAL.greek.circumflex.beta, mn(0)),
            space(4), mo`-`, space(4), mul2(msub(SPECIAL.greek.circumflex.beta, mn(1)), msub(mi`x`, mrow(mi`i`, mn(1)))),
            space(4), mo`-`, space(4), mul2(msub(SPECIAL.greek.circumflex.beta, mn(2)), msub(mi`x`, mrow(mi`i`, mn(2)))),
            space(4), SPECIAL.ellipse.h2,
            space(4), mo`-`, space(4), mul2(msub(SPECIAL.greek.circumflex.beta, mi`k`), msub(mi`x`, mrow(mi`i`, mi`k`))),
            space(4), mo`.`
          ),
        ],
        ...
        [
          ...
          eq(
            frac(
              ...
              [
                mrow(mi`n`, space(4), mo`-`, space(4), mi`k`, space(4), mo`-`, space(4), mn(1)),
              ],
            ),
            mrow(
              frac(
