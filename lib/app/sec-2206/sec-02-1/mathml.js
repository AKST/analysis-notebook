...
const { SPECIAL: S, rows, annotationOver, annotationUnder, sum, call, inv, parensA, table, eqId, eq, add, minus } = mathmlHelper_2;
    ...
    mathml.math(
      eq(
        ...
        add3(
          ...
          mul2(msub(greek.circumflex.beta, mn(1)), msub(mi`x`, mn(1))),
          mul2(msub(greek.circumflex.beta, mn(2)), msub(mi`x`, mn(2)))
        )
      )
    ),
    ...
    mathml.math(
      eq(
        ...
        add(
          mul2(
            msub(greek.circumflex.beta, mn(1)),
            mul2(greek.Delta, msub(mi`x`, mn(1)))
          ),
          mul2(
            msub(greek.circumflex.beta, mn(2)),
            mul2(greek.Delta, msub(mi`x`, mn(2)))
          )
        )
      )
    ),
...
export const sizeKMLR = {
  ...
  ols: () => {
    const inner = parensA(
      ...
      mul2(msub(S.greek.circumflex.beta, mn(1)), msub(mi`x`, mrow(mi`i`, mn(1)))),
      mspace(4), mo`-`, mspace(4),
      S.ellipse.h2, mspace(4), mo`-`, mspace(4),
      mul2(msub(S.greek.circumflex.beta, mi`k`), msub(mi`x`, mrow(mi`i`, mi`k`))),
    );
  ...
  partialEffect: doc.figure(
    mathml.math(
      eq(
        ...
        mrow(
          mul2(msub(greek.circumflex.beta, mn(1)), mul2(greek.Delta, msub(mi`x`, mn(1)))),
          mspace(4), mo`+`, mspace(4),
          mul2(msub(greek.circumflex.beta, mn(2)), mul2(greek.Delta, msub(mi`x`, mn(2)))),
          mspace(4), mo`+`, mspace(4),
          S.ellipse.h2,
          mspace(4), mo`+`, mspace(4),
          mul2(msub(greek.circumflex.beta, mi`k`), mul2(greek.Delta, msub(mi`x`, mi`k`)))
        )
      )
    ),
    doc.figcaption`Ceteris Paribus interpretation`
    ...
    mathml.math(
      eq(
        ...
        mrow(
          msub(greek.circumflex.beta, mn(0)),
          mspace(4), mo`+`, mspace(4),
          mul2(msub(greek.circumflex.beta, mn(1)), msub(mi`x`, mrow(mi`i`, mn(1)))),
          mspace(4), mo`+`, mspace(4),
          mul2(msub(greek.circumflex.beta, mn(2)), msub(mi`x`, mrow(mi`i`, mn(2)))),
          mspace(4), mo`+`, mspace(4),
          S.ellipse.h2,
          mspace(4), mo`+`, mspace(4),
          mul2(msub(greek.circumflex.beta, mi`k`), msub(mi`x`, mrow(mi`i`, mi`k`)))
        )
      )
    ),
  ...
  mathml.math(
    table.attr({ columnalign: 'right center left' })(
      [
        ...
        add3(
          msub(greek.circumflex.beta, mn(0)),
          mul2(msub(greek.circumflex.beta, mn(1)), msub(mi`x`, mi`1i`)),
          add(
            mul2(msub(greek.circumflex.beta, mn(2)), msub(mi`x`, mi`2i`)),
            msub(mi`û`, mi`i`)
          ),
        ),
      ],
      [
        ...
        add3(
          ...
          mul2(msub(greek.circumflex.beta, msub(mn(1), mn(2))), msub(mi`x`, mi`1i`)),
      ...
      [
        ...
        add3(
          ...
          mul2(msub(beta, mrow(mn(1), msub(mi`x`, mn(2)))), msub(mi`x`, mi`1i`)),
          add(
            mul2(
      ...
      table(
        [
          ...
          mrow(
            ...
            mspace(4), mo`-`, mspace(4), mul2(msub(greek.circumflex.beta, mn(1)), msub(mi`x`, mrow(mi`i`, mn(1)))),
            mspace(4), mo`-`, mspace(4), mul2(msub(greek.circumflex.beta, mn(2)), msub(mi`x`, mrow(mi`i`, mn(2)))),
            mspace(4), S.ellipse.h2,
            mspace(4), mo`-`, mspace(4), mul2(msub(greek.circumflex.beta, mi`k`), msub(mi`x`, mrow(mi`i`, mi`k`))),
            mspace(4), mo`.`
          ),
        ],
