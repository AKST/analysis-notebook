...
export function render() {
  return doc.details({ name: 'week', className: 'dashbox' }).of(
    doc.summary({ className: 'h2' }).of(doc.h2`Week 5 — Predictive Analytics, Part 2`),
    container(
      container(
        ...
        twoColumns(
          ...
          container(
            ...
            ul(
              ...
              doc.p`${text.b`t_alpha/2`} is the critical value from the t
              ...
              `,
              doc.p`${text.b`SE_pred`} is the standard error of the prediction`,
            ),
          ),
        ),
        ...
        `,
        ul(
          doc.p`${text.b`Bias in model selection`}:
          ...
          `,
          doc.p`${text.b`NOt reflective of real world perfmance or lack of generalizablity`}:
      ...
      container(
        ...
        doc.p`
          ...
          stand out as forms of predictions is they: ${doc.br()}${doc.br()}${ul(
            doc.p`
      ...
      container(
        ...
        twoColumns(
          container(
            doc.h4`Regression`,
            ul(
              doc.p`${text.b`Y`} is quatitative, continious`,
              doc.p`
          ...
          container(
            ...
            ul(
              doc.p`${text.b`Y`} is qualitative, nominal`,
              doc.p`
