...
const IMAGES = {
  imperfectMarkets: doc.img.css({
    ...
    src: import.meta.resolve('@assets/econ/imperfect-markets.png'),
    height: 120,
  }),
  survivorship: doc.img.css({
    ...
    src: import.meta.resolve('@assets/econ/survivorship-bias.png'),
    height: 120,
  }),
  taxWedge: doc.img.css({
    ...
    src: import.meta.resolve('@assets/econ/tax-wedge.png'),
    height: 107,
  }),
  ipartFounder: doc.figure.css({
    ...
    doc.img({
      src: import.meta.resolve('@assets/econ/ipart-founder.png'),
      height: 161,
    }),
