...
const IMAGES = {
  imperfectMarkets: doc.img({
    src: './assets/econ/imperfect-markets.png',
    height: '120px',
    style: 'float: left; margin-right: 16px;',
  }),
  survivorship: doc.img({
...
const INFOBOX = {
  effiencyVsEquity: infobox({ title: 'Effiency Vs Equity' }).of(
    text.p.m`
  ...
  adValoremTax: infobox({ title: 'Ad Valorem Tax' }).of(
    text.p.m`
...
export const taxesAndSubsidies = {
  ...
  render: (_ctx, _state) => container(
    ...
    twoThree(
      ...
      container(
        infobox({ title: "Constraint solving Equilibrium" }).of(
          doc.div({ className: 'equilibrium-equation' }).of(
    ...
    twoColumns(
      dashbox(
        ...
        `,
        doc.h4`Subsidy ${doc.s`Burden`} ${doc.i`Beneficiary`}`,
        doc.p`
