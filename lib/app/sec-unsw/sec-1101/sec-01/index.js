/**
 * @import { Vec2, MakeConfigKnobs, Widget } from '@app/prelude-type.ts';
 * @import { AgentState, Config, State, Event } from './type.ts';
 */

import * as prelude from '@app/sec-unsw/sec-1101/prelude.js';
import { vector, convexHull, COLOR, math, doc, objects } from '@app/prelude.js';
