...
export const children = [
  {
    meta: { kind: 'document' },
    render: (_ctx, state, _cfg) => doc.div({ className: 'container' }).c(
      ...
      twoColumns(
        container(
          ...
          doc.ul.c(
            text.li.l.c(text.p.l`${text.b`α:`} by dividing β by α.`),
            text.li.l.c(text.p.l`${text.b`β:`} by dividing α by β.`),
          ),
      ...
      twoThree(
        ...
        container(
          infobox({ title: 'Absolute Advantage' }).c(
            text.p.m`
  ...
  },
  {
    ...
    render: () => container(
      twoThree(
        ...
        infobox({ title: 'What causes a PPC to move?' }).c(
          doc.p`
  ...
  {
    meta: { kind: 'document' },
    render: (_ctx, state, cfg) => doc.div({ className: 'container' }).c(
