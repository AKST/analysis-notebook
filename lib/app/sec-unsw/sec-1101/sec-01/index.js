...
export const children = [
  {
    meta: { kind: 'document' },
    render: (_ctx, state, _cfg) => doc.div({ className: 'container' }).of(
      ...
      twoThree(
        ...
        infobox({ title: 'What is a PPC?' }).of(
          text.p.m`
      ...
      twoColumns(
        container(
          ...
          doc.ul.of(
            text.li.l.of(text.p.l`${text.b`α:`} by dividing β by α.`),
            text.li.l.of(text.p.l`${text.b`β:`} by dividing α by β.`),
          ),
      ...
      twoThree(
        ...
        container(
          infobox({ title: 'Absolute Advantage' }).of(
            text.p.m`
    ...
    render: () => container(
      twoThree(
        doc.p({ style: 'grid-row: 1 / 2' }).of(`
          ...
          text.i`Possiblities`, ' that come from trade.',
        ),
        infobox({ title: 'What causes a PPC to move?' }).of(
          doc.p`
  ...
  {
    meta: { kind: 'document' },
    render: (_ctx, state, cfg) => doc.div({ className: 'container' }).of(
