...
import { rows, sum, set, SPECIAL, parensA } from '@prelude-uni/mathml.js';
...
export const verticalSummation = () => mathml.math(
  rows(
    mrow(
...
export const lindahlPrice = () => mathml.math(
  rows(
    mrow(
      optimalQ, mspace(4), mo`=`, mspace(4),
      mfrac(mrow(optimalP, mo`-`, mspace(4), optimalA), optimalB),
    ),
    mrow(
