...
const INFOBOX = {
  enclosure: infobox({ title: 'Enclosure' }).c(
    text.p.m`
  ...
  verticalSummation: infobox({ title: 'Vertical Summation' }).c(
    text.p.m`
      ...
      or service.
    `,
    doc.span({ style: 'font-size: 16px' }).c(
      mathml.verticalSummation()
    ),
  ),
  lindhalPrice: infobox({ title: 'Lindhal Price' }).c(
    text.p.m`
  ...
  render: () => container(
    dashbox(
      twoThree(
        ...
        infobox({ title: 'Examples of Public Goods' }).c(
          text.p.m`
      ...
      twoThree(
        ...
        infobox({ title: 'Fairness in Taxation' }).c(
          container(
            text.p.m`
