...
const IMAGES = {
  pareto: doc.img.css({
    ...
    src: import.meta.resolve('@assets/econ/pareto.png'),
    height: 144,
  }),
  paretoImprovingTransaction: doc.img.css({
    ...
    src: import.meta.resolve('@assets/econ/pareto-improving-transaction.png'),
    height: 120,
  }),
  smith: doc.img({
    src: import.meta.resolve('@assets/econ/adam-smith.png'),
    height: 138,
    className: 'adamSmith',
  }),
  rationing: doc.img.css({
    ...
    src: import.meta.resolve('@assets/econ/rationing-2.png'),
    height: 130,
  ...
  competition: doc.img.css({
    ...
    src: import.meta.resolve('@assets/econ/perfect-competition.png'),
    height: 107,
  ...
  privateGoods: doc.img.css({
    ...
    src: import.meta.resolve('@assets/econ/private-goods.png'),
    height: 107,
    title: 'Cheese',
  }),
};
