...
const INFOBOXES = {
  supermarketEnquiry: infobox({ title: '2024-25 Supermarket Enquiry' }).of(
    text.p.m`${IMAGES.supermarketEnquiry}
      ...
      barriers to entry for new partipants. [${
        doc.a({ href: LINKS.supermarketEnquiry }).of(
          'read more here'
        )
      }]`,
    text.p.m`
      ...
      applications to build a grocery store get ${
        doc.a({ href: LINKS.woolworthsButtsHeadWithCouncil }).of(
          'challenged'
        )
