...
export const header = {
  ...
  render: (_ctx, state) => container(
    ...
    twoThree(
      ...
      `,
      infobox({ title: 'Decreasing marginal utility' }).of(
        text.p.m`
    ...
    text.p.l`
      We call this ${text.b`Utils per unit of time`} often with
    ...
    twoColumns(
      doc.dl(
        ...
        doc.dd.of(text.p.l`
          ...
          ${text.b`Quantity Demanded`} for muffins.
        `),
        ...
        doc.dd.of(text.p.l`
          ...
          the ${text.b`Substitution effect`}. This is almost
      ...
      doc.dl(
        ...
        doc.dd.of(text.p.l`
          The ${text.b`Income Effect`} is when the demand
          for a ${text.b`normal good`} increases as income
          increases, and demand for an ${text.b`Inferior good`}
          decreases.
        `),
  ...
  render: (_ctx, state) => container(
    ...
    twoThree(
      container(
        ...
        text.p.l`
          The ${text.b`reservation price`} is also the vertical
      ...
      infobox({ title: 'Reservation Price' }).of(
        container(
          text.p.m`
          ...
          `,
          text.figure(mathml.reservationPrice()),
        ),
      )
    ),
    twoThree(
...
export const relativeValue = {
  ...
  render: (_ctx, state) => container(
    ...
    twoThree(
      ...
      infobox({ title: 'Relative Value' }).of(
        container(
          text.figure(mathml.relativeValue()),
        )
      ),
    ),
    text.p.l`
...
export const curveShifts = {
  ...
  render: () => container(
    ...
    `,
    doc.ul({ className: 'c2' }).of(
      doc.li`An increase in the price of substitutes`,
      doc.li`Decrease in the price of complements`,
      doc.li`${text.b`Inferior good`}: an decrease in the income.`,
      doc.li`${text.b`Normal good`}: an increase in the income.`,
...
export const elascity = {
  ...
  render: (_ctx, state) => container(
    ...
    twoColumns(
      doc.dl(
        doc.dt`Avaiablilty of Subtitutes`,
        doc.dd.of(
          text.p.l`
