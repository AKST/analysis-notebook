    ...
    resetVariant: text.figure(
      math(
        eq(mi`y`, add(
          ...
          mo`⋯`,
          mul0(msub(mi`β̂`, mi`k`), msub(mi`x`, mi`k`)),
          mul0(msub(mi`δ̂`, mn(1)), msup(mi`ŷ`, mn({ style: 'color: #ff0099' })(2))),
          mul0(msub(mi`δ̂`, mn(2)), msup(mi`ŷ`, mn({ style: 'color: #ff0099' })(3))),
        )),
      ),
      ...
      mtable(
        eq.mtr({ pos: ['right', 'left'] })(
          ...
          eq(
            ...
            mul0(minus.paren(mi`x`, call({ fn: mtext`E` })(mi`x`)), msub(mi`β`, mn(0)))
          ),
        ),
        eq.mtr({ pos: ['right', 'left'] })(
          ...
          eq(
            ...
            mul0(minus.paren(mi`x`, call({ fn: mtext`E` })(mi`x`)), msub(mi`β`, mn(1)))
          ),
        )
      )
    ),
...
export const measurementError = {
  ...
  cev: {
    covariance: text.figure(
      math(
        eq(
          call({ fn: mtext`Cov` })(msub(mi`x`, mi`j`), minus(mi`u`, mul0(msub(mi`β`, mi`j`), msub(mi`e`, mi`j`)))),
          mul0(neg(msub(mi`β`, mi`j`)), call({ fn: mtext`Cov` })(msub(mi`x`, mi`j`), msub(mi`e`, mi`j`))),
  ...
  lad: text.figure(
    math(
      mrow(
        ...
        mspace(4),
        sum({ max: mi`n`, inc: eq.sub(mi`i`, mn(1)) })(
          abs(
            rows(
              minus(
                msub(mi`y`, mi`i`),
  ...
  implication: text.figure(
    math({ style: '--fontsize-math-m: 14px' })(
      table({ columnalign: 'left right center left' })(
        ...
        [
          mo`∧`,
          call({ fn: mtext`Med` })(op.cond(mi`u`, mi`x`)),
          mo`=`,
          mn(0)
        ],
        [
          mo`⇒`,
          call({ fn: mtext`Med`, paren: '[]' })(
            op.cond(call({ fn: mtext`log` })(mi`y`), mi`x`),
          ),
          mo`=`,
          add(
            msub(mi`β`, mn(0)),
        ...
        [
          mo`∧`,
          call({ fn: mtext`Med` })(op.cond(mi`y`, mi`x`)),
          mo`=`,
          call({ fn: mtext`exp` })(
            add(
              msub(mi`β`, mn(0)),
