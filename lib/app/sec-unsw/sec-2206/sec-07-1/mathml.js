  ...
  regression: doc.figure(
    math(
      eq(
        ...
        add(
          msub(mi`𝛽`, mn(0)),
          mul0(msub(mi`𝛽`, mn(1)), msub(mi`x`, mrow(mi`i`, mn(1)))),
          mo`⋯`,
          mul0(msub(mi`𝛽`, mi`j`), msub(mi`x`, mrow(mi`i`, mi`j`))),
          mo`⋯`,
          mul0(msub(mi`𝛽`, mi`k`), msub(mi`x`, mrow(mi`i`, mi`k`))),
          mul0(msub(mi`𝛼`, mn(0)), msub(mi`Z`, mrow(mi`i`, mi`k`))),
          mul0(msub(mi`𝛼`, mn(1)), msub(mi`m`, mrow(mi`i`, mi`k`))),
          mi`u`
        )
      )
    ),
