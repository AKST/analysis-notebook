...
export const intro = createDoc(() => container(
  twoThree(
    ...
    infobox({ title: 'Resources' }).of(
      ...
      text.ul(
        doc.li.of(LINKS.paper.ramsey1969.t`Ramsey 1969, specification errors`),
      ),
    ),
  ),
));
...
export const usingProxyVariables = createDoc(() => container(
  ...
  dashbox(
    ...
    twoColumns(
      ...
      doc.div({ style: '--fontsize-math-m: 12px' }).of(mathml.proxy.solve),
    ),
    container(
  ...
  dashbox(
    container(
      doc.p`
        ...
        grocery spending).
      `,
      text.ul({ className: 'c2', style: 'grid-gap: 32px' }).of(
        doc.li`
      ...
      `,
      doc.p`
        This would be a mistake, ${text.b.of(text.b`its worth stressing
        ${text.i`two`} ways in which how the nature of these two things are
        fundermentally different`)}:
      `,
      text.ol({ className: 'c2', style: 'grid-gap: 32px' }).of(
        doc.li`
          With ${text.b.of(text.b`Proxy Variables`)}, we are looking for a
          variable that is somehow associated with the unobserved variable.
          With ${text.b.of(text.i`Measurement Error`)}, the variable that we
        ...
        `,
        doc.li`
          With ${text.b.of(text.i`Measurement Error`)} the primary thing of
          interst is  mismeasured independent variable. However with
          ${text.b.of(text.b`Proxy Variables`)}, the partial effect of the
          omitted variable is rarely of central interest, as we are
          usually more concerned with the effects of the other independent
          variables. The goal of a ${text.b.of(text.b`Proxy Variables`)} is
          typically to control for the effect of the unobserved variable.
        `,
      ),
      doc.p`
        In summary, ${text.b.of(text.i`one is a subsitute for what we like to
