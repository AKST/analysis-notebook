  ...
  twoThree(
    container(
      doc.h1.c(
        ...
        doc.br(),
        doc.small.css({ color: '#aaaaff' }).t`ECON2206, W7, Lecture 1`,
      ),
    ),
...
export const usingProxyVariables = createDoc(() => container(
  ...
  dashbox(
    ...
    twoColumns(
      ...
      doc.div.cssVar({ '--fontsize-math-m': '12px' }).c(mathml.proxy.solve),
    ),
    container(
  ...
  dashbox(
    container(
      doc.p`
        ...
        grocery spending).
      `,
      text.ul({ className: 'c2' }).css({ gridGap: '32px' }).c(
        doc.li`
      ...
      `,
      text.ol({ className: 'c2' }).css({ gridGap: '32px' }).c(
        doc.li`
    ...
    container(
      ...
      twoColumns(
        ...
        doc.div.cssVar({ '--fontsize-math-m': '14px' }).c(
