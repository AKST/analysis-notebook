  ...
  twoThree(
    container(
      doc.h1`
        ...
        ${doc.small.css({ color: '#aaaaff' }).t`ECON2206, W5, Lecture 2`}
      `,
    ),
    ...
    twoColumns(
      ...
      container(
        ...
        text.ul(
          ...
          doc.li`Therefore we can't perform${text.ul.cssVar({ '--fontsize-body-m': '10px' }).c(
  ...
  dashbox(
    ...
    twoThree(
      ...
      container(
        ...
        doc.div({ className: 'container' }).cssVar({ '--fontsize-body-m': '10px' }).c(
