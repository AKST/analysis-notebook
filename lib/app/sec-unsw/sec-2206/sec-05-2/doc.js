      ...
      container(
        ...
        text.ul(
          ...
          doc.li`Therefore we can't perform${text.ul({ style: '--fontsize-body-m: 10px' }).of(
            doc.li`${text.b.of(text.b`T tests`)}${text.ul(
              doc.li`Our t distributions will not be t distributions.`,
            )}`,
            doc.li`${text.b.of(text.b`F tests`)}${text.ul(
              doc.li`Our F distributions will not be F distributions.`,
            )}`,
            doc.li`${text.b.of(text.b`LM statistic`)}${text.ul(
  ...
  dashbox(
    doc.quote`
      Run the following in STATA for robust standard errors ${(
        text.b.of(text.i`reg wage educ, robost`)
      )}.
    `,
    twoThree(
      container(
        doc.p`
          ...
          we'll call the
          ${text.b.of(text.b`Heteroskedasticity-robust standard error`)} (HRSE).
        ...
        doc.p`
          ...
          because now we have a ${text.b.of(text.b`Heteroskedastic
  ...
  dashbox(
    twoThree(
      container(
        ...
        `,
        text.ul(
          doc.li.of(text.b`The error is proportional to the level of income`, '.'),
          doc.li.of(text.b`As income increases, the variance increases`, '.'),
          doc.li.of(text.b`The Standard Deviation of û is conditional on income`, '.'),
        ),
