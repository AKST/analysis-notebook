...
export const robustInference = createDoc(() => container(
  ...
  dashbox(
    ...
    twoThree(
      container(
        doc.p`
          The remedy the issue of Heteroskedascity, we can use a variety methods
          called ${doc.b`Heteroskedasticity-robust`} prodecures, and we can
          follow these to obtain the ${doc.b`Heteroskedasticity-robust
          standard error`}.
        `,
