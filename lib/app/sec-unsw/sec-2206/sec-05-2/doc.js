...
export const intro = createDoc(() => container(
  twoThree(
    ...
    infobox({ title: 'Resources' }).of(
      ...
      text.ul(
        doc.li.of(LINKS.wiki.breuschPaganTest.t`Breush Pagan Test`),
      ),
    ),
  ),
  doc.h2`Introduction`,
  ...
  dashbox(
    twoColumns(
      container(
        ...
        text.ul(
          doc.li`${doc.b`SSR/n`} consistently estimates ${doc.b`σ${doc.sub`u`}${doc.sup`2`}`}`,
          doc.li`${doc.b`SST/n`} consistently estimates ${doc.b`σ${doc.sub`y`}${doc.sup`2`}`}`,
          doc.li`
      ...
      container(
        ...
        text.ul(
          doc.li`${doc.b`Var(β̂ⱼ)`}, due to biased estimator.`,
          doc.li`${doc.b`SE(β̂ⱼ)`}, because we can't estimate ${doc.b`Var(β̂ⱼ)`}`,
          doc.li`Therefore we can't perform${text.ul({ style: '--fontsize-body-m: 10px' }).of(
  ...
  dashbox(
    ...
    twoThree(
      container(
        ...
        doc.p`
          Note the ${doc.b`i`} subscript on ${doc.b`σ²`}, also note the
      ...
      container(
        ...
        infobox({ title: 'Reading List' }).of(
          text.ul(
            doc.li.of(LINKS.paper.white1980.t`White 1980`),
            doc.li.of(LINKS.paper.huber1967.t`Huber 1967`),
            doc.li.of(LINKS.paper.eicker1967.t`Eicker 1967`),
            doc.li.of(LINKS.paper.white1985.t`MacKinnon and White 1985`),
          ),
        ),
        infobox({ title: 'Convergence' }).of(
           doc.p`Read later`,
           text.ul(
            doc.li.of(LINKS.wiki.convergenceTest.t`Convergence Test`),
            doc.li.of(LINKS.wiki.rateOfConvergence.t`Rate of Convergence`),
          ),
        ),
...
export const testingHeteroskedasticity = createDoc(() => container(
  ...
  dashbox(
    twoThree(
      ...
      container(
        infobox({ title: "Exam note" }).of(doc.p`It is expected to be perform this from memory in the exam.`),
        infobox({ title: "Distribution of u²/σ²" }).of(
          doc.p`
        ...
        container(
          ...
          text.ul(
            ...
            doc.li`
              ...
              asymptotically as ${doc.b`χₖ²`}.
            `,
          ),
        ),
        infobox({ title: 'Testing specfic Variables' }).of(
          doc.p`
    ...
    twoThree(
      ...
      container(
        ...
        infobox({ title: 'White test Summary' }).of(
          text.ol(
  ...
  dashbox(
    twoThree(
      container(
        doc.p`
          ...
          using ${doc.b`weighted least squares`}. Using WLS will
          also mean new ${doc.b`t`} and ${doc.b`F`} statistics
          which have their respective ${doc.b`t/F distribution`}.
        `,
        ...
        doc.p`
          ...
          expresss it with syntax like ${doc.b`h(x)`}, which is some
          function on the relevant explanatory variable. So if that
          explanatory variable is income then your variance could be
          written like ${doc.b`σ² · income`}. In practise that means:
        `,
        text.ul(
          doc.li.of(doc.b`The error is proportional to the level of income`, '.'),
          doc.li.of(doc.b`As income increases, the variance increases`, '.'),
          doc.li.of(doc.b`The Standard Deviation of û is conditional on income`, '.'),
        ),
        ...
        doc.p`
          ...
          variant of ${doc.b`Generalised Least Squares`}, and they
        ...
        doc.p`
          ...
          useful as a goodness of fit measure. ${doc.b`Because it
      ...
      container(
        infobox({ title: "variance under heteroskedascity" }).of(
        ...
        doc.dl(
          ...
          doc.dd`
            ...
            to the level of ${doc.b`x`}.
          `,
          doc.dt`GLS`,
          doc.dd`Generalised Least Squares`,
        ),
        infobox({ title: 'When to use WLS' }).of(
          doc.p`
        ...
        infobox({ title: "WLS, Weighted by what?" }).of(
          doc.p`
        ...
        infobox({ title: "WLS/FGLS different signs to OLS" }).of(
          doc.p`
            ...
            ${doc.b`Typically, this indicates that one of the
            other Gauss-Markov assumptions is false`}, in
            particular the zero conditional mean assumption
            on the error.
          `,
        ),
        infobox({ title: "Functional form misspecification" }).of(
          doc.p`
    ...
    container(
      ...
      doc.p`
        ...
        the ${doc.b`h`} and use the data to estimate the unknown parameters
        in this model.
      `,
      doc.p`
      ...
      twoColumns(
        doc.p`
          ...
          which we'll call ${doc.b`ĝᵢ`}, from here we can simply estimate
          ĥᵢ as:
        `,
      ...
      doc.p`
        ...
        ${doc.b`we can always just use heteroskedasticity-robust standard
      ...
      doc.p`
        ...
        (at least if h(x) is positive). ${doc.b`This is why, we can
      ...
      `,
      doc.p`
        Thankfully there is a simple fix, ${doc.b`just as we can obtain
