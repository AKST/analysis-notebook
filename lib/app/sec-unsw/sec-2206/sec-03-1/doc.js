  ...
  twoThree(
    container(
      doc.h1.c(
        ...
        doc.small.css({ color: '#aaaaff' }).t`ECON2206, W3, Lecture 2`,
      ),
    ),
...
export const hypothesisTestingTDist = createDoc(() => container(
  ...
  dashbox(
    ...
    doc.blockquote`Note the population regression function as expressed on the right.`,
    columns('even-2', [
      doc.p`
...
export const hypothesisTestingOneSided = createDoc(() => dashbox(
  twoThree(
    container(
      ...
      doc.blockquote`Example of One Sided Alternative Hypothesis ${text.b`H₁:  βⱼ > 0`}`,
      doc.p`
