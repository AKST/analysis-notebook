...
const INFOBOX = {
  populationParamaters: infobox({ title: 'Population Parameters' }).of(
    doc.p`
  ...
  noteOnIndexSyntax: infobox({ title: 'Note on Index Syntax' }).of(
    doc.p`
  ...
  propertiesOfSummation: infobox({ title: 'Properties of Summation' }).of(
    todo({}, 'Write me later'),
  ),
  betaOneIsARandomVariable: infobox({ title: 'β̂₁ is a random variable' }).of(
    doc.p`
  ...
  twoThree(
    container(
      doc.h1.of(
        ...
        doc.small({ style: 'color: #aaaaff' }).of('ECON2206, W1, Lecture 2'),
      ),
      doc.p`
