...
export const predictionAndResidualAnalysis = createDoc(() => container(
  ...
  dashbox(
    ...
    text.ol({ itemSpace: 'sparse' }).of(
      doc.li`${doc.b`Var(ŷ⁰)`}: Sampling error in ŷ⁰ (as a result of esimating βⱼ)${text.ul(
        doc.li`Var(ŷ⁰) is proportional to 1/n, as samples grow Var(ŷ⁰) will shrink.`,
      )}`,
      doc.li`${doc.b`Var(u⁰) / σ²`}: Unobserved randomness, as the variance of the redisuals u⁰.`,
    ),
