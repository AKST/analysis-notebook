...
export const functionalForms = {
    ...
    math(
      rows(
        eq(
          ...
          add(
            msub(mi`β`, mn(0)),
            mul(msub(mi`β`, mn(1)), call({ fn: mtext`log` }).c(msub(mi`x`, mn(1)))),
            add(
        ...
        mrow(
          annotationOver({ label:  mtext`with x₁ fixed` }).c(
            eq(
              mi`%Δŷ`,
              mul(
                mn(100),
                minus.paren(
                  call({ fn: mtext`exp` }).c(mul(msub(mi`β`, mn(2)), msub(mi`Δx`, mn(2)))),
                  mn(1)
                )
              )
            ),
  ...
  quadratic: text.figure(
    math(
      table({ columnalign: 'right centre left' }).c(
        [
          mi`y`,
          mo`=`,
          add(
      ...
      table({ columnalign: 'right center left' }).c(
        ...
        [
          ...
          add(
            ...
            mul(msub(SPECIAL.greek.beta, mn(1)), call({ fn: mtext`log` }).c(msub(mi`x`, mn(1)))),
            mul(
              msub(SPECIAL.greek.beta, mn(2)),
              msup(parensA(call({ fn: mtext`log` }).c(msub(mi`x`, mn(1)))), mn(2))
            )
          ),
        ],
            ...
            mrow(
              ...
              add(
                ...
                mul(
                  ...
                  mul(
                    msub(SPECIAL.greek.beta, mn(2)),
                    call({ fn: mtext`log` }).c(msub(mi`x`, mn(1)))
                  ),
                )
              ),
              mo`]`,
  ...
  partialEffect: text.figure(
    mathml.math({ className: 'big-math' }).c(
      mrow(
        eq(mi`y`, add(
          msub(mi`α`, mn(0)),
...
export const predictions = {
  ...
  varianceOfPredictionError: text.figure(
    math(
      mrow(
        eq(
          call({ fn: mtext`Var` }).c(msup(mi`ê`, mn(0))),
          add(
            call({ fn: mtext`Var` }).c(msup(mi`ŷ`, mn(0))),
            call({ fn: mtext`Var` }).c(msup(mi`u`, mn(0)))
          ),
          add(
            call({ fn: mtext`Var` }).c(msup(mi`ŷ`, mn(0))),
            msup(greek.sigma, mn(2))
  ...
  seOfPredictionError: text.figure(
    math(
      eq(
        call({ fn: mtext`se` }).c(msup(mi`ê`, mn(0))),
        msup(
          parensC(
            add(
              msup(
                parensB(call({ fn: mtext`se` }).c(msup(mi`ŷ`, mn(0)))),
                mn(2)
              ),
              msup(greek.sigma, mn(2))
            )
