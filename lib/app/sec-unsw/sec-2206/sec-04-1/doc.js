...
export const intro = createDoc(() => container(
  twoThree(
    ...
    infobox({ title: 'Resources' }).of(
      text.ul(
        doc.li`Chapter 5`,
        doc.li.of(LINKS.asymptoticTheory.t`Asymptotic Theory`),
        doc.li.of(LINKS.asymptoticTheory.t`Probability Limits`),
        doc.li.of(LINKS.samplingDistribution.t`Sampling Distribution`),
      )
    ),
  ),
));
