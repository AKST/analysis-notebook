    ...
    twoThree(
      container(
        ...
        text.ul({ itemSpace: 'sparse' }).of(
          doc.li`
            ${text.b.of(text.b`horizon`)}: This is the effect after a permanent ${text.b`1 unit change`}
            after h periods.
          `,
          doc.li`
            ${text.b.of(text.b`LRP`)}: This is the effect after a permanent ${text.b`change of any value`}
            after h periods.
          `,
        ),
        doc.quote`
    ...
    twoThree(
      container(
        ...
        container(
          ...
          doc.quote`Require our explanator variables to be ${text.b`strictly exogenous`}.`,
