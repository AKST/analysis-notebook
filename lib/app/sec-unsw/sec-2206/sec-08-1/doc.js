  ...
  twoThree(
    ...
    infobox({ title: 'Resources' })(
      text.ul(
        ...
        doc.li.of(LINKS.spuriousRegressions`Spurious regressions`),
      ),
    ),
  ),
));
  ...
  dashbox(
    ...
    twoThree(
      container(
        ...
        container(
          ...
          infobox({ title: 'u correlated with xⱼ' })(
            doc.p`In practise:`,
            text.ul(
      ...
      container(
        ...
        infobox({ title: "Theorum: unbiasness of OLS" })(
          doc.p`
            Under TS.1-3, the OLS estimators are unbiased
            conditional on ${doc.b`X`} and therefore
            unconditionally as well as when:${doc.br()}
            ${doc.br()}
            ${doc.b`E(𝛽̂ⱼ) = 𝛽ⱼ, j ∈ {0, 1, ..., k}`}
          `,
        ),
        infobox({ title: "Theorum: Unbiased Esimation of 𝜎²" })(
          doc.p`
            Under TS.1-5, the estimator 𝜎̂² = SSR/df is an
            unbiased estimator of 𝜎² where:${doc.br()}
            ${doc.b`df = n - k - 1`}.
          `,
          doc.h4`In FDL`,
          doc.p`
        ...
        infobox({ title: "Theorum: Guass-Markov Theorum" })(
          doc.p`
            Under TS.1-5, OLS estimators are the best linear
            unbiased estimators on ${doc.b`X`}.
          `,
        ),
        infobox({ title: "Normal Sampling Distribution" })(
          doc.p`
    ...
    container(
      ...
      twoThree(
        ...
        `,
        infobox({ title: 'TS.6 Normality' })(
          doc.p`
            The errors uₜ are independent of X and are independently and
            identically distributed as ${doc.b`Normal(0, 𝜎²)`}.
          `,
        ),
      ),
    ),
      ...
      container(
        doc.dl(
          ...
          doc.dd`
            ...
            the ${doc.b`immediate propensity`} 𝛿₀.
          `,
