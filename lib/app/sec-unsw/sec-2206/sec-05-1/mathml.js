    ...
    rows(
      eq(
        ...
        add(
          msub(mi`𝛽`, mn(0)),
          munder(
            mul0(msub(mi`𝛿`, mn(0)),  msub(mi`x`, mn(1))),
            mtext`dummy`,
          ),
          munder(
            mul0(msub(mi`𝛽`, mn(1)),  msub(mi`x`, mn(2))),
            mtext`slope`,
          ),
          munder(
            mul0(msub(mi`𝛿`, mn(1)),  msub(mi`x`, mn(1)), msub(mi`x`, mn(2))),
            mtext`interaction`,
          ),
          mi`u`,
        ),
...
export const interactionSlope = doc.figure(
  math(
    eq(
      mi`y`,
      add(
        ...
        munder(
          mul0(msub(mi`𝛽̂`, mn(3)),  msub(mi`x`, mn(1)), msub(mi`x`, mn(2))),
          mtext`interaction`,
        ),
        mi`u`,
      ),
...
export const chowTest = {
  models: {
      ...
      math(
        eq(
          ...
          add(
            msub(mi`𝛽̂`, mn(0)),
            munder(
              mul0(msub(mi`𝛽̂`, mn(1)),  msub(mi`s`, mn(1))),
              mtext`slope 1`,
            ),
            munder(
              mul0(msub(mi`𝛽̂`, mn(2)),  msub(mi`s`, mn(2))),
              mtext`slope 2`,
            ),
            munder(
              mul0(msub(mi`𝛽̂`, mn(3)),  msub(mi`s`, mn(3))),
              mtext`slope 3`,
            ),
            mi`u`,
          ),
    ...
    withGroup: doc.figure(
      math(
        table({ columnalign: 'right center left' })(
          [mi`y`, mo`=`, add(
            munder(
              mul0(msub(mi`𝛿`, mn(0)), msub(mi`d`, mn(1))),
              mtext`dummy`,
            ),
            munder(
              mul0(msub(mi`𝛽`, mn(1)),  msub(mi`s`, mn(1))),
              mtext`slope 1`,
            ),
            munder(
              mul0(msub(mi`𝛿`, mn(1)), msub(mi`d`, mn(1)),  msub(mi`s`, mn(1))),
              mtext`interaction`,
            ),
            munder(
              mul0(msub(mi`𝛽`, mn(2)),  msub(mi`s`, mn(2))),
              mtext`slope 2`,
            ),
            mspace(0),
          )],
          [mspace(0), mspace(0), add(
            munder(
              mul0(msub(mi`𝛿`, mn(2)), msub(mi`d`, mn(1)),  msub(mi`s`, mn(2))),
              mtext`interaction`,
            ),
            munder(
              mul0(msub(mi`𝛽`, mn(3)),  msub(mi`s`, mn(3))),
              mtext`slope 3`,
            ),
            munder(
              mul0(msub(mi`𝛿`, mn(3)), msub(mi`d`, mn(1)),  msub(mi`s`, mn(3))),
              mtext`interaction`,
            ),
            mi`u`,
          )],
    ...
    withSeperateRegressions: doc.figure(
      math(
        eq(
          msub(mi`y`, mi`g`),
          add(
            msub(mi`𝛽̂`, comma.sub(mi`g`, mn(0))),
            mul0(msub(mi`𝛽̂`, comma.sub(mi`g`, mn(1))),  msub(mi`s`, mn(1))),
            mul0(msub(mi`𝛽̂`, comma.sub(mi`g`, mn(2))),  msub(mi`s`, mn(2))),
            mul0(msub(mi`𝛽̂`, comma.sub(mi`g`, mn(3))),  msub(mi`s`, mn(3))),
            mi`u`,
          ),
        ),
      ),
    ...
    null: doc.figure(
      math(
        mrow(
          ...
          mo`:`, mspace(4),
          comma(
            eq(msub(mi`𝛿`, mn(0)), mn(0)),
            eq(msub(mi`𝛿`, mn(1)), mn(0)),
            eq(msub(mi`𝛿`, mn(2)), mn(0)),
            eq(msub(mi`𝛿`, mn(3)), mn(0)),
          ),
        ),
      ),
