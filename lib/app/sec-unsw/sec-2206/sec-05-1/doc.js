...
export const dummyVariablesForMultiCategories = createDoc(() => container(
  ...
  dashbox(
    twoThree(
      container(
        text.ul(
          doc.li`Say you have a model with 2 variables, ${text.b`gender`} and ${text.b`married`}.${text.ul({ itemSpace: 'sparse' }).of(
    ...
    twoThree(
      ...
      doc.dl(
        ...
        doc.dd.of(doc.quote`
          ...
          [${doc.cite.of(text.b`wikipedia, 2025-10-23`)}]
        `),
    ...
    twoThree(
      ...
      doc.dl(
        ...
        doc.dd`
          ...
          and one. Define a predicted value as ${text.b.of(text.b`ỹᵢ = 1 if ŷᵢ ≥ .5 and ỹᵢ < .5`)}.
          Now we have a set of predicted values, ${text.b.of(text.b`ỹᵢ = { 1, ..., n }`)}
