...
export const intro = createDoc(() => container(
  twoThree(
    container(
      doc.h1.c(
        'Multiple Regression Analysis with Qualitative Info', doc.br(),
        doc.small.css({ color: '#aaaaff' }).t`ECON2206, W5, Lecture 1`,
      ),
    ),
  ...
  dashbox(
    text.ul({ itemSpace: 'sparse' }).c(
      ...
      `,
      doc.li`
        The ${text.b`linear probability model`} (LPM) will be introduced which is a
  ...
  dashbox(
    twoThree(
      container(
        ...
        mathml.dummyEffects,
        doc.p`
          ${text.b`δ₀`} represents the mean difference in the
        ...
        text.ul({ itemSpace: 'sparse' }).c(
          doc.li`Coefficients have a percentage interpretation${text.ul({ itemSpace: 'sparse' }).c(
            doc.li`
...
export const dummyVariablesForMultiCategories = createDoc(() => container(
  ...
  dashbox(
    twoThree(
      container(
        text.ul(
          doc.li`Say you have a model with 2 variables, ${text.b`gender`} and ${text.b`married`}.${text.ul({ itemSpace: 'sparse' }).c(
    ...
    twoThree(
      container(
        ...
        doc.p`
          ...
          we denote with ${text.b`g`}. You will have a seperate group
      ...
      container(
        ...
        infobox({ title: 'SE\'s on dummy slope interactions' }).c(
          doc.p`
            Don't be alarmed if you see ${text.b`much larger standard
        ...
        infobox({ title: 'Chow Test Degree of Freedom' }).c(
          doc.p`
        ...
        doc.dl.cssVar({ '--fontsize-math-m': '12px' }).c(
        ...
        infobox({ title: 'A Limitation of Chow Test' }).c(
          doc.p`
...
export const binaryDependentVariable = createDoc(() => container(
  ...
  dashbox(
    doc.blockquote`You may want to do this if you want to explain a ${text.b`Qualitative event`}.`,
    twoThree(
      container(
        doc.p`
          ${text.b`When the ${text.i`dependent variable`} of a model is a ${text.b`qualative
          variable`}, it takes on ${text.i`only 2 values`}, being ${text.b`zero`} or
          ${text.b`one`}`}. One Interpretation of this is the model output acts as
        ...
        doc.p`
          ...
          ${text.b`${text.b`Coefficients`} cannot be interpreted as a one unit
          change in ${text.i`x${doc.sub`j`}`} in the value of ${text.i`y`}`}.
        `,
        ...
        doc.p`
          ...
          Another thing to keep in mind ${text.b`with correctly
          interpreting a linear probability model, we must know
          what ${text.i`constitutes`} a ${text.b`“success”`}`}.
        ...
        doc.blockquote`
          ...
          probability that ${text.b`y = 1`}. These models are
          fairly easy to estimate and interpret.
        `,
      ),
      doc.dl(
        doc.dt`Conditional Probability`,
        doc.dd.c(doc.blockquote`
          ... ${LINKS.conditionalProbability.t`Conditional Probability`}
          ...
          [${doc.cite.c(text.b`wikipedia, 2025-10-23`)}]
        `),
    ...
    twoThree(
      text.ul({ itemSpace: 'sparse' }).c(
        doc.li`
          ${text.b`We can get predictions either less than zero or greater than one`}:
      ...
      doc.dl(
        ...
        doc.dd`
          ...
          and one. Define a predicted value as ${text.b.c(text.b`ỹᵢ = 1 if ŷᵢ ≥ .5 and ỹᵢ < .5`)}.
          Now we have a set of predicted values, ${text.b.c(text.b`ỹᵢ = { 1, ..., n }`)}
          that, like the yi, are either zero or one.
          ${doc.br()}${doc.br()}

          We can use the data on ${text.b`yᵢ = 1 and yᵢ = 0`} as the proportion
    ...
    doc.p`
      ...
      one of the Gauss-Markov assumptions. ${text.b`When y is a binary variable,
      its variance, conditional on x`}, is:
      ${doc.br()}${mathml.lpmAssumptionViolation}${doc.br()}
      The implication is ${text.b`heteroskedasticity`}.
    `,
  ),
));
