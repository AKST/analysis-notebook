    ...
    twoThree(
      container(
        ...
        doc.p`
          ...
          as a ${text.b.of(text.b`intertemporal trade function`)}. In this
          case we can think ${text.b.of(text.i`International trade as perfect
          risk-sharing`)}.
        `,
        doc.figure(
      ...
      container(
        ...
        infobox({ title: 'Trade MUST balance in the long run' }).of(
          doc.p`
            When you hear this ${text.b.of(text.b`MUST`)}, think in
            an ${text.b.of(text.i`economic equilibrium logic`)} sense.
    ...
    twoThree(
      ...
      container(
        ...
        infobox({ title: 'Paul Samuelson: on trade' }).of(
          doc.p.of(LINKS.wtoPaul.t`[From here]`),
          doc.quote`
