...
export const intro = createDoc(() => container(
  twoThree(
    container(
      doc.h1.c(
        'International Trade', doc.br(),
        doc.small({ style: 'color: #aaaaff' }).t`ECON2102, W9, Lecture 1`,
      ),
    ),
...
export const introduction = createDoc(() => container(
    ...
    twoColumns(
      container(
        ...
        doc.p`
          ...
          2020).
        `,
        doc.h4({ className: 'transport-animation' }).t`Transport costs`,
        doc.p`
          This is in part due to a ${text.b`reduction in
        ...
        doc.p`
          ...
          a ${text.b`reduction of trade barriers`}. Trade
        ...
        doc.p`
          ...
          (this is called the ${text.b`the trade balance`}).
      ...
      container(
        infobox({ title: 'Trade Balance, closed world economy' }).c(
          doc.p`
        ...
        `,
        infobox({ title: 'Trade within Sydney' }).c(
          doc.p`
        ...
        doc.p`
          ...
          as the motivation for trade within a country: ${text.b`people
          trade because ${text.b`they value goods that other people
          produce more at the margin`} than ${text.i`they value what
          they themselves own`}`}.
        `,
        doc.p`
  ...
  doc.div({ className: 'footnotes dashbox container' }).c(
    doc.h6`${doc.span({ className: 'icon' }).t`⚠️`} Footnotes`,
    text.ol(
      doc.li`
...
export const tradeAcrossTime = createDoc(() => container(
  ref({ page: 537 }, doc.h2({ className: 'hour-glass-animation' }).t` Trade across Time`),
  dashbox(
    twoThree(
      container(
        doc.p`
        ...
        `,
        doc.h4({ className: 'globe-animation' }).t`An example!`,
        doc.p`
          For example sake ${text.b`lets consider two wheat producing
          countries in a reality in which wheat perishes`} ${text.i`(it
          doesn't really which is why wheat houses exist, but it can be
          spoiled)`}. If these two countries want to smooth their
          consumption — ${text.b`as in maintain the rate at which they consume
        ...
        doc.p`
          ...
          as a ${text.b.c(text.b`intertemporal trade function`)}. In this
          case we can think ${text.b.c(text.i`International trade as perfect
          risk-sharing`)}.
        `,
        doc.figure(
          text.b`In the long run, trade must be balanced`,
      ...
      container(
        ...
        infobox({ title: 'Trade MUST balance in the long run' }).c(
          doc.p`
            When you hear this ${text.b.c(text.b`MUST`)}, think in
            an ${text.b.c(text.i`economic equilibrium logic`)} sense.
            It assumes a ${text.b`no-Ponzi condition`} where no country
        ...
        infobox({ title: 'Is running a deficit bad?' }).c(
          doc.p`
    ...
    twoThree(
      container(
        ...
        doc.p`
          ...
          they have a ${text.b`absolute advantage`}. Despite
        ...
        doc.p`
          ...
          they are more expensive (this is called ${text.b`arbitrage`}).
      ...
      container(
        ...
        infobox({ title: 'Paul Samuelson: on trade' }).c(
          doc.p.c(LINKS.wtoPaul.t`[From here]`),
          doc.quote`
    ...
    twoColumns(
      ...
      container(
        doc.p`
          ...
          ${text.b`In theory, the south could even negotiate with the
    ...
    twoColumns(
      container(
        ...
        doc.p`
          ...
          transition. ${text.b`There is some level of structural
          unemployment here`}.
        `,
      ),
      container(
  ...
  dashbox(
    twoColumns(
      container(
        ...
        doc.quote`
          Cases where the ${text.b`permanent-income hypothesis`} does not hold
        `,
        doc.p`
        ...
        doc.p`Below implies ${text.b`private investment`} equals ${text.b`total saving`}.`,
      ...
      container(
        ...
        doc.p`
          ...
          between these two is called the ${text.b`net international
