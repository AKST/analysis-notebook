...
export const wheatHarvests = doc.figure(
  doc.table({ className: 'paddedTable' })(
    doc.tr(
      doc.th`Year`,
      doc.th`1`,
      doc.th`2`,
    ...
    doc.tr(
      doc.th({ colSpan: 7 })`Wheat harvest`,
    ),
    doc.tr(
      doc.th`Oddtopia`,
      doc.td`100`,
    ...
    doc.tr(
      doc.th({ colSpan: 7 })`Trade balance`,
    ),
    doc.tr(
      doc.th`Oddtopia`,
      doc.td.of(doc.font({ color: 'green' })`+50`),
      doc.td.of(doc.font({ color: 'red' })`−50`),
      doc.td.of(doc.font({ color: 'green' })`+50`),
      doc.td.of(doc.font({ color: 'red' })`−50`),
      doc.td.of(doc.font({ color: 'green' })`+50`),
      doc.td.of(doc.font({ color: 'red' })`−50`),
...
export const northSouthSetup = doc.figure(
...
export const northSouthAutarky = doc.figure(
  doc.table({ className: 'really-wide setupTable' })(
    doc.tr(
      doc.th``,
      doc.th`North`,
      doc.th`South`,
...
export const northSouthFreeTrade = doc.figure(
  doc.table({ className: 'really-wide setupTable' })(
    doc.tr(
      doc.th``,
      doc.th`North`,
...
export const northSouthFreeMigration = doc.figure(
  doc.table({ className: 'really-wide setupTable' })(
    doc.tr(
      doc.th``,
    ...
    doc.tr(
      doc.th`Total production in the apple sector`,
      doc.td({ colSpan: 2 })`40,000 🍎`,
    ),
    doc.tr(
      doc.th`Total production in the computer sector`,
      doc.td({ colSpan: 2 })`4,000 💻`,
    ),
  ),
