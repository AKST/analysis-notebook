...
export const header = createDoc(() => container(
  twoThree(
    container(
      doc.h1.of('Labour Markets', doc.br(),
...
export const risingReturnToEducation = createDoc(() => dashbox(
  container(
    twoThree(
      ...
      infobox({ title: 'Returns To Education' }).of(
        doc.p`You can read more here:`,
        doc.ul({ className: 'no-item-padding' }).of(
          doc.li.of(LINKS.worldBankReturnsToEducation.t`World Bank`),
          doc.li.of(LINKS.scienceDirectReturnsToEducation.t`Science Direct`),
          doc.li.of(LINKS.educationNSWReturnsToEducation.t`Education NSW`),
        ),
      ),
    ),
    twoColumns(
