...
export const header = createDoc(() => container(
  twoThree(
    container(
      doc.h1.c('Labour Markets', doc.br(),
        doc.small({ style: 'color: #aaaaff' }).t`ECON2102, W3, Lecture 1`
      ),
      doc.p`
  ...
  twoThree(
    container(
      container(
        ...
        text.ul(
          doc.li`${text.b`Employment-population Ratio`}:
            ...
            the labour force.
          `,
          doc.li`${text.b`Unemployment Rate`}:
      ...
      container(
        ...
        doc.p`
          Both ${text.b`job creation`} and ${text.b`job destruction`}
          can be generalised under the term ${text.b`gross flows`}.
        ...
        text.ul(
          doc.li`
            ...
            and a ${text.b`job finding rate`} means most spells on unemployment
    ...
    doc.dl(
      ...
      doc.dd`
        ...
        force and everyone not in the ${text.b`labour force`}
        (occassionally excludes in the military).
      `,
      doc.dt`Employed population Ratio`,
      doc.dd`
        This is the ${text.b`Working age population`} divided by the
        number of people who are ${text.b`Employed`}.
      `,
      doc.dt`Labour Force`,
      doc.dd`
        Everyone who is ${text.b`Employed`} and ${text.b`Unemployed`}. Or
        the working population minus those not working and not looking
        for work.
      `,
      doc.dt`Not in the workforce`,
      doc.dd`
        Those in the ${text.b`working age population`} who are not working
        and are not looking for a job. Such as a student or stay at home
        parent.
      `,
      doc.dt`Gross Flows`,
      doc.dd`
        The Net sum of ${text.b`job creations`} and ${text.b`job destructions`}.
      `,
    ),
  ),
...
export const supplyAndDemand = createDoc(() => dashbox(
  ...
  twoColumns(
    text.ul(
      doc.li`${text.b`The Labour demand curve`}${text.ul(
      ...
      doc.li`${text.b`The Labour supply curve`}${text.ul(
    ...
    text.ul(
      doc.li`${text.b`The X axis`}${text.ul(
        doc.li`Units of labour provided by workers`,
      )}`,
      doc.li`${text.b`The Y axis`}${text.ul(
        doc.li`Units of wages offered by employers`,
      )}`,
      doc.li`${text.b`Equilibrium`} this represents${text.ul(
  ...
  container(
    ...
    twoThree(
      ...
      container(
        doc.h4`Model Terms`,
        text.ul(
          doc.li`${text.b`s`}: job seperation rate`,
          doc.li`${text.b`f`}: job finding rate`,
          doc.li`${text.b`L`}: Labour`,
          doc.li`${text.b`E`}: Employment`,
          doc.li`${text.b`U`}: Unemployment`,
        ),
      ),
    ),
    responsiveGridAutoRow([
...
export const valueOfHumanCapital = createDoc(() => container(
  ...
  dashbox(
    ...
    twoThree(
      doc.p`
        ${text.b`Present discounted value`} is useful for calculating
    ...
    twoThree(
      doc.p`
        ...
        ${text.b`R`} is the expected rate of interest, and ${text.b`T`}
    ...
    twoThree(
      container(
        ...
        doc.p`
          ...
          a question arises... ${text.b`How is it that the wage of
      ...
      infobox({ title: 'Returns To Education' }).c(
        doc.p`You can read more here:`,
        doc.ul({ className: 'no-item-padding' }).c(
          doc.li.c(LINKS.worldBankReturnsToEducation.t`World Bank`),
          doc.li.c(LINKS.scienceDirectReturnsToEducation.t`Science Direct`),
          doc.li.c(LINKS.educationNSWReturnsToEducation.t`Education NSW`),
        ),
      ),
    ),
    twoColumns(
...
export const economicGrowthAndIncomeInequality = createDoc(() => dashbox(
  ...
  doc.p`
    ...
    prior to this between 1946 adn 1980 the opposite is true. ${text.b`That said`},
