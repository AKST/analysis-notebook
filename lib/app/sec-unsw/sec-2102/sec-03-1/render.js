...
/**
 * Page 185 or 210 show supply demand with income tax
 * Y Axis = Wage
 * X Axis = Employment
 *
 * Show income tax as a wedge on market.
 */
export const supplyAndDemand = makePlaceholer(
  'Labour Market supply and demand',
  { height: 300, gridColumn: { default: 2, s: 2 } },
);


export const returnToEducationHS = makePlaceholer(
  'Return To Education High School',
  { height: 300, gridColumn: { default: 1, s: 2 } },
);

export const returnToEducationUni = makePlaceholer(
  'Return To Education Uni',
  { height: 300, gridColumn: { default: 1, s: 2 } },
);
