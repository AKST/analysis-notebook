...
export const unemploymentRate = text.figure(
  mathml.math(
    mrow(
...
export const actualUnemployment = text.figure(
  mathml.math(
    mrow(
...
export const bathtubModel = {
  ...
  solveForUnemployment: text.figure(
    mathml.math(
...
export const valueOfHumanCapital = {
  presentDiscountedRate: text.figure(
    mathml.math.attr({ style: 'font-size: 12px' }).c(
      mrow(
  ...
  presentDiscountedValueOfSalary: text.figure(
    mathml.math.attr({ style: 'font-size: 12px' }).c(
      eq(
        mtext`PDV`,
        mul(
