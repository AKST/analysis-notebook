...
export const intro = createDoc(() => container(
  twoThree(
    container(
      doc.h1.c(
        'Government Spending', doc.br(),
        doc.small({ style: 'color: #aaaaff' }).t`ECON2102, W8, Lecture 1`,
      ),
    ),
  ...
  dashbox(
    twoThree(
      container(
        ...
        doc.p`
          ${text.b`Generally`}: If your future prospects look good, lenders may
      ...
      container(
        ...
        infobox({ title: 'On Crowding out' }).c(
          doc.p`
    ...
    twoThree(
      container(
        container(
          ...
          `,
          text.ul(
            doc.li`In ${text.b`1950`} entitlement spending was 0.3% of GDP`,
            doc.li`In ${text.b`2000`} this percent has risen to 7.6% of GDP`,
          ),
        ...
        container(
          ...
          doc.p`
            ...
            ${text.b`However`}, this is hardly unique to the USA, Japans much
            older population spends less on health (as share of GDP) than the
            USA. Research from ${LINKS.papers.newhouse1992.t`Joseph Newhouse`}
      ...
      container(
        infobox({ title: 'Note' }).c(
          doc.p`This section is very US centric.`,
        ),
        infobox({ title: 'CBO 2002 report' }).c(
          doc.p`
            The CBO in the USA released a report titled
            ${LINKS.cbo2002.t`A 125-Year Picture of the Federal
        ...
        infobox({ title: 'Moral case for a Sustainable budget' }).c(
          doc.p`
          ...
          doc.p`
            ...
            who come after us. ${text.b`At the same time`}, we should be
