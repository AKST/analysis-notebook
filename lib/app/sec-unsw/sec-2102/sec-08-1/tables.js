...
export const usFederalBudget2018 = text.figure(
  doc.table({ className: 'setupTable paddedTable' }).c(
    doc.tr(
      doc.th``,
    ...
    doc.tr(
      doc.th({ style: 'background: deeppink' }).t`Total expenditures`,
      doc.td`20.0`,
      doc.td`12,550`,
    ),
    doc.tr(
    ...
    doc.tr(
      doc.th({ style: 'background: deeppink' }).t`Total revenues`,
      doc.td`16.2`,
      doc.td`10,170`,
    ),
    doc.tr(
    ...
    doc.tr(
      doc.th({ style: 'background: deeppink' }).t`Budget deficit`,
      doc.td`−3.8`,
      doc.td`−2,380`,
    ),
  ),
