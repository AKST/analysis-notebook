...
export const intertemporalDebtEvolution = doc.figure(
  math(
    eq(
      msub(mi`B`, add.sub(mi`t`, mn(1))),
      add(
...
export const primaryBudgetBalance = doc.figure(
  math(
    eq(
      msub(mi`B`, mi`t`),
      minus(
...
export const debtToGdpRatio = doc.figure(
  math(
    eq(
...
export const bondValue = doc.figure(
  math(
    eq(
...
export const privateSectorSavings = doc.figure(
  math(
