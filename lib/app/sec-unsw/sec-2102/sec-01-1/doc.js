...
export const cesProductionFunction = createDoc(() => dashbox(
  ...
  doc.p`
    ...
    states as well, which tends to vary with ${doc.b`𝜌`}.
  `,
  text.ul(
    doc.li`${doc.b`𝜌 = 1`}: it resembles a flat plane, 𝛼 rotates it`,
    doc.li`${doc.b`𝜌 > 0`}: it Begins to flatten as it approaches 1`,
    doc.li`${doc.b`𝜌 = 0`}: it acts like Cobb Douglas`,
    doc.li`${doc.b`𝜌 → -∞`}: it forms a Leontief production function, as it approach negative inifinity`,
  ),
));
