  ...
  twoThree(
    container(
      doc.h1`
        Macroeconomics 2
        ${doc.br()}
        ${doc.small({ style: 'color: #6666ff' })`Aggregate Production`}
        ${doc.br()}
        ${doc.small({ style: 'color: #aaaaff' })`ECON2102, W1, Lecture 1`}
      `,
    ),
...
export const modelOfProduction = createDoc(() => dashbox(
  ...
  doc.p`
    ...
    revision on the ${LINKS.wiki.cobbDouglas`Cobb Douglas`}
...
export const cesProductionFunction = createDoc(() => dashbox(
  ...
  twoThree(
    ...
    infobox({ title: 'Functions' }).of(
      text.ul(
        doc.li`${LINKS.wiki.cobbDouglas`Cobb Douglas`}`,
        doc.li`${LINKS.wiki.ces`Constant elasticity of substitution`}`,
        doc.li`${LINKS.wiki.leontief`Leontief production function`}`,
      ),
    ),
  ),
  doc.p`
    The ${LINKS.wiki.cobbDouglas`Cobb Douglas`} production function
    is not the only aggregate production function. Another such
    function includes the ${LINKS.wiki.ces`Constant elasticity of
