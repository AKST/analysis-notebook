  ...
  twoThree(
    ...
    infobox({ title: 'Resources' }).of(
      ...
      text.ul(
        ...
        doc.li.of(LINKS.laboursDecliningShareOfIncome.t`Labor's Declining Share of Income`),
        doc.li.of(LINKS.wiki.solowSwan.t`Wikipedia Solow Swan`),
        doc.li.of(LINKS.data.worldBank.t`World Bank Data`),
        doc.li.of(LINKS.data.pennWorldTable.t`Penn World Table`, ': data for s̄, d̄, Ā, ᾱ'),
      ),
    ),
  ),
));
