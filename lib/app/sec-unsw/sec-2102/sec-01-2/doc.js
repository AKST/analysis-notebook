...
const READMORE = {
  ...
  rentalPriceOfCapitalAndWageRate: readmore({
    ...
    details: [
      ...
      `,
      noteOn('Review')(
        doc.li`Real wage is equal to the marginal product of labour at L̄`,
      ),
    ],
  }),
  returnToSavings: readmore({
    ...
    details: [container(
      ...
      note(
        doc.li`In Solow model, one unit of investment earns the marignal product of captial`,
        doc.li`Investment comes from savings`,
        doc.li`The return to savings / the real interest rate, ieq equal to rental price of capital`,
      ),
    )]
  }),
};
  ...
  twoThree(
    container(
      doc.h1`
        ...
        ${doc.small.css({ color: '#aaaaff' }).t`ECON2102, W1, Lecture 2`}
      `,
      text.ul(
        doc.li`Focus:`,
