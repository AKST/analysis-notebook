...
export const intro = createDoc(() => container(
  twoThree(
    ...
    infobox({ title: 'Resources' }).of(
      ...
      text.ul(
        doc.li.of(LINKS.romer.t`Romer Paper`),
        doc.li.of(LINKS.romerInterview.t`Romer Interview`),
        doc.li.of(LINKS.nobelPrize.t`Nobel Prize`),
        doc.li.of(LINKS.base44.t`AI app platform`, ': mentioned by lecturer.'),
      ),
    ),
  ),
));
