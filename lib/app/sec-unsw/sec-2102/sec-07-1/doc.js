...
export const intro = createDoc(() => container(
  twoThree(
    container(
      doc.h1.c(
        'Consumption', doc.br(),
        doc.small.css({ color: '#aaaaff' }).t`ECON2102, W7, Lecture 1`,
      ),
    ),
...
export const introduction = createDoc(() => container(
  ...
  dashbox(
    doc.p`
      In the ${text.b`neoclassical consumption model`}, individuals choose
...
export const neoclassicalModel = createDoc(() => container(
  ...
  dashbox(
    ...
    doc.p`
      ...
      two main elements, an ${text.b`intertemporal budget constraint`} and a
      ${text.b`utility function`}.
    `,
    twoThree(
      container(
        ref({ page: 461 }, doc.h4`The Intertemporal Budget Constraint`),
        doc.div.cssVar({ '--fontsize-math-m': '12px' }).c(
        ...
        doc.p`
          ...
          must equal total wealth. It includes both ${text.b`financial wealth`}
          (todays wealth), and ${text.b`human wealth`} (income today and
        ...
        doc.p`
          ...
          if someone consumes some amount ${text.b`c`} in a given period, we
          assume that he receives ${text.b`u(c)`} units of utility, sometimes
          called ${text.b`“utils”`}.
        `,
        doc.p`
        ...
        doc.p`
          ...
          how much in the future. The parameter ${text.b`β`} is some number
        ...
        doc.p`
          ${text.b`X̄`} denotes total wealth which is the sum of financial
      ...
      container(
        infobox({ title: 'Legend' }).c(
          text.ul(
            doc.li`${text.b`R`}: Real Interest Rate`,
            doc.li`${text.b`f`}: Financial wealth`,
            doc.li`${text.b`y`}: Labour Income`,
            doc.li`${text.b`c`}: Consumption`,
          ),
        ),
        doc.dl(
          doc.dt`Intertemporal Budget Constraint`,
          doc.dd`Says that the present discounted value of consumption must equal ${text.b`total wealth`}`,
          doc.dt`Total Wealth`,
          doc.dd`A combination of ${text.b`financial wealth`} and ${text.b`human wealth`}`,
          doc.dt`Financial Wealth`,
          doc.dd`
            This is expressed as ${text.b`f${doc.sub`today`}`}, and is generally stuff
            such as savings, stock, bonds, and other financial assets.
          `,
          doc.dt`Human Wealth`,
          doc.dd`
            The present discounted value of labour income, also expressed as
            ${text.b`f${doc.sub`future`}`}.
          `,
        ...
        infobox({ title: 'Legend' }).c(
          text.ul(
            doc.li`${text.b`β`}: weight placed on the future`,
            doc.li`${text.b`X̄`}: Totl welaht over lifetime`,
          ),
        ),
        doc.dl(
        ...
        infobox({ title: 'Interpreting β' }).c(
          text.ul({ itemSpace: 'sparse' }).css({ paddingLeft: '16px' }).c(
            doc.li`When ${text.b`β = 1`}, utility from consumption today is equal from comsumption in the future`,
            doc.li`When ${text.b`β < 1`}, utility from consumption today is worth more than in the future`,
            doc.li`When ${text.b`β > 1`}, utility from consumption in the future is worth more than in the present`,
          ),
        ),
      ),
    ),
    container(
      ...
      twoColumns(
        container(
          doc.p`
            ...
            of being easy to derive ${text.b`u'(c) = 1/c`}.
          `,
          doc.p`
      ...
      text.ul(
        doc.li`
          ${text.b`The substitution effect`} of a higher interest rate is that
        ...
        `,
        doc.li`
          ${text.b`The income effect`} says that consumers are now richer
  ...
  dashbox(
    twoThree(
      container(
        ...
        doc.p`
          Aspects of the ${text.b`Permanent-Income Hypothesis`} can be
          expressed as a constraint on ${text.b`X̄`} suggesting
          consumption is propotional to a consumers overall wealth.
        `,
        mathml.consumptionProportionalToWealth,
        doc.blockquote`This depends on the present ${text.b`discount value of income`}.`,
        doc.p`
        ...
        doc.blockquote`Ricardian Equivalence suggest ${text.b`y`} is as income ${text.b`after taxes`}.`,
        doc.p`
          The implication of the ${text.b`Ricardian Equivalence`} suggests
          that ${text.b`Taxes`} must be subtracted from the right
          hand side of the intertemporal budget constraint.
        `,
        mathml.richardianEquivalenceIbc,
        doc.p`
          Additional lifetime wealth ${text.b`X̄`} now is the present discounted
        ...
        doc.p`
          ...
          save or borrow at the ${text.b`market interest rate R`}. This describes
        ...
        doc.p`
          ...
          such scenario the ${text.b`intertemporal budget constraint`} is no
      ...
      container(
        doc.dl(
          ...
          doc.dd`
            Consumption shifts by the ${text.b`MPC`}
        ...
        infobox({ title: 'Does Ricardian Equivalence hold?' }).c(
          doc.p`
    ...
    twoColumns(
      container(
        ...
        doc.blockquote`
          See ${LINKS.paper.randomWalk.t`Robert E. Hall (1978)`}.
        `,
        doc.p`
        ...
        doc.p`
          This part of what is meant by ${text.b`random walk view of
      ...
      container(
        ...
        doc.blockquote`Read more ${LINKS.paper.consumptionAndliquidityConstraints.t`here`}.`,
        doc.p`
          ...
          or disability. This type of saving is called ${text.b`precautionary
          saving`}.
        `,
        doc.p`
        ...
        `,
        doc.p`
          The precautionary saving motive can, lead consumers to ${text.b`behave
          as if they ${text.b`face borrowing constraints`} ${text.i`even when they
          do not`}`}.
        `,
        doc.p`
          ...
          spread of possible values of ${text.b`β`}.
        `,
      ),
    ),
  ),
    ...
    twoColumns(
      container(
        ...
        doc.p`
          ...
          ${text.b`Heterogeneous`}, meaning we can come up with a common
          ...
          a point in time but there is no single measure of the ${text.b`marginal
        ...
        doc.p`
          ${text.b`Behaviour economics`} is one of the most active areas
      ...
      container(
        ...
        doc.p`
          ...
          to GDP (we call the this decrease ${text.b`deleveraging`}).
        `,
        doc.p`
          This rise in household debt was coincided with a decrease
          in a large steady declince in the ${text.b`personal savings rate`}.
  ...
  dashbox(
    text.figure(
      responsiveGridAutoRow([
        doc.div({ className: 'container' }).css({
          justifyItems: 'left',
        }).c(
          responsiveGridAutoRow([
