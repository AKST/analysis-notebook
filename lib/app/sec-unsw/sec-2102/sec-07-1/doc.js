  ...
  dashbox(
    ...
    twoThree(
      container(
        ...
        doc.div({ style: '--fontsize-math-m: 12px' }).of(
      ...
      container(
        ...
        infobox({ title: 'Interpreting β' }).of(
          text.ul({ itemSpace: 'sparse', style: 'padding-left: 16px' }).of(
  ...
  dashbox(
    twoThree(
      container(
        ...
        doc.quote`This depends on the present ${text.b`discount value of income`}.`,
        doc.p`
        ...
        doc.quote`Ricardian Equivalence suggest ${text.b`y`} is as income ${text.b`after taxes`}.`,
        doc.p`
      ...
      container(
        ...
        infobox({ title: 'Does Ricardian Equivalence hold?' }).of(
          doc.p`
    ...
    twoColumns(
      ...
      container(
        ...
        doc.quote`Read more ${LINKS.paper.consumptionAndliquidityConstraints.t`here`}.`,
        doc.p`
