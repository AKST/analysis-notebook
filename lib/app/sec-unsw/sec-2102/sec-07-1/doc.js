  ...
  dashbox(
    ...
    twoThree(
      ...
      container(
        ...
        infobox({ title: 'Interpreting 𝛽' })(
          text.ul({ itemSpace: 'sparse', style: 'padding-left: 16px' })(
            doc.li`When ${doc.b`𝛽 = 1`}, utility from consumption today is equal from comsumption in the future`,
            doc.li`When ${doc.b`𝛽 < 1`}, utility from consumption today is worth more than in the future`,
            doc.li`When ${doc.b`𝛽 > 1`}, utility from consumption in the future is worth more than in the present`,
          ),
        ),
      ),
    ),
