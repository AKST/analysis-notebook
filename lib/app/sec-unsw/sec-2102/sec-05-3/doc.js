...
export const header = createDoc(() => container(
  twoThree(
    container(
      doc.h1.of('MP Curve', doc.br(), doc.small.attr({ style: 'color: #aaaaff' }).t`
    ...
    infobox({ title: 'Resources' }).of(
      text.ul(
        ...
        doc.li.of(LINKS.wiki.arbitrage.t`Arbitrage`),
        doc.li.of(LINKS.wiki.classicalDichotomy.t`Classical Dichotomy`),
      ),
    ),
  ),
));
  ...
  dashbox(
    ...
    twoThree(
      doc.p`
        ...
        bank ${text.i.of(doc.u`sets it by supplying whatever money is
    ...
    twoThree(
      ...
      infobox({ title: 'Nominal Interest in the short run' }).of(
        doc.p`
