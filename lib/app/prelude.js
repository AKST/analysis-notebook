...
export { v2, convexHull, shoelaceArea } from '../base/geom-2d/index.js';
...
// future
export { frag } from '../base/dsl-dom/render.js';
export * as doc from '../base/dsl-dom/helper/html.js';
export * as svg from '../base/dsl-dom/helper/svg.js';
export * as mathml from '../base/dsl-dom/helper/mathml.js';

// transition
export { frag as frag2 } from '../base/dsl-dom/render.js';
export * as doc2 from '../base/dsl-dom/helper/html.js';
export * as svg2 from '../base/dsl-dom/helper/svg.js';
export * as mathml2 from '../base/dsl-dom/helper/mathml.js';
