    ...
    twoThree(
      container(
        doc.p`
          ...
          Squares. It started with the question ${text.b`Can I use complex
          ...
          ${text.b`I also learnt complex numbers are polynomials`}. The
          ...
          multiplication. So then I wondered ${text.b`Can we use arbirarary
      ...
      container(
        infobox({ title: 'sources' }).c(
          text.ul(
            doc.li`Groups:${text.ul(
              doc.li.c(LINKS.yt.groupA.t`Part 1`),
              doc.li.c(LINKS.yt.groupB.t`Part 2`),
              doc.li.c(LINKS.yt.groupC.t`Part 3`),
            )}`,
            doc.li.c('Rings: ', LINKS.yt.ring.t`watch`),
            doc.li`Fields:${text.ul(
              doc.li.c(LINKS.yt.fieldA.t`Part 1`),
              doc.li.c(LINKS.yt.fieldA.t`Part 2`),
            )}`,
            doc.li.c('Vector Spaces: ', LINKS.yt.vectorSpace.t`watch`),
            doc.li.c('Modules: ', LINKS.yt.modules.t`watch`),
          ),
        ),
        doc.dl(
        ),
