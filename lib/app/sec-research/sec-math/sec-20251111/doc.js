        ...
        infobox({ title: 'sources' }).of(
          text.ul(
            doc.li`Groups:${text.ul(
              doc.li.of(LINKS.yt.groupA`Part 1`),
              doc.li.of(LINKS.yt.groupB`Part 2`),
              doc.li.of(LINKS.yt.groupC`Part 3`),
            )}`,
            doc.li.of('Rings: ', LINKS.yt.ring`watch`),
            doc.li`Fields:${text.ul(
              doc.li.of(LINKS.yt.fieldA`Part 1`),
              doc.li.of(LINKS.yt.fieldA`Part 2`),
            )}`,
            doc.li.of('Vector Spaces: ', LINKS.yt.vectorSpace`watch`),
            doc.li.of('Modules: ', LINKS.yt.modules`watch`),
          ),
        ),
        doc.dl(
        ),
...
export const generalisedComplexNumbers = createDoc(() => container(
  ...
  dashbox(
    twoThree(
      container(
        doc.p`
          I saw ${LINKS.yt.iIsASetOfPolyNomials`this video`} it lead to me
