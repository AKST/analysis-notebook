...
export const someLeads = createDoc(() => container(
  ...
  dashbox(
    ...
    doc.h4`Examples`,
    text.ul(
      doc.li.of(PDF_MODELS.rigby2005.t`GAMLSS from 2005`),
      doc.li.of(PDF_MODELS.fong2025.t`Temporal mixture density networks for enhanced investment modeling`),
      doc.li.of(PDF_MODELS.will2025.t`Exploring the Application of a Mixture Density Network to the Australian Housing Market`),
    ),
  ),
));
