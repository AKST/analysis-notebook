...
const { inv, paren, call, frac } = mathml;

const { mi, mo, mtext, mrow, mover, mn, msub, msup, mspace } = mathml2;

const { set, sum, rows } = mathmlHelper2;
const { greek, cursive, rel, ellipse, operation } = mathmlHelper2.SPECIAL;
