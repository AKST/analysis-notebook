...
export function getConfig() {
  ...
  return {
    ...
    priceX: { kind: 'number', of: 2, range: [0.01, 10] },
    priceY: { kind: 'number', of: 3, range: [0.01, 10] },
    agents: {
      kind: 'many',
      of: {
    ...
    render: (_ctx, state, _cfg) => ['div', { className: 'container' }, [
      ...
      twoColumns(
        ['div', {}, [
          ...
          doc.p("TODO, explain how OC is used for minimial acceptable trade"),
        ]],
    ...
    render: () => container(
      ...
      ['div', { className: 'c2' }, [
        ['div', { className: 'container' }, [
          ['h3', ['Modelling PPC']],
          doc.font({ color: 'red' }, 'TODO - insert algorithm/forumular'),
        ]],
        ['div', { className: 'container' }, [
          ['h3', ['Modelling CPC']],
          doc.font({ color: 'red' }, 'TODO - insert algorithm/forumular'),
