 ...
 * @import { Econ, E, Widget, RenderContextInit as Init } from '../../prelude-type.ts';
 */
...
export const priceFloor = makeWidget({
  ...
  if (state.floorModel == null) return undefined;
  return [state.floorInput, state.floorModel];
});
...
export const priceCeil = makeWidget({
  ...
  if (state.ceilingModel == null) return undefined;
  return [state.ceilingInput, state.ceilingModel];
});
...
export const demandTax = makeWidget({
  ...
  if (state.taxModel == null) return undefined;
  return [state.taxInput, state.taxModel];
});
...
export const demandSubsidy = makeWidget({
  ...
  if (state.subsidyModel == null) return undefined;
  return [state.subsidyInput, state.subsidyModel];
});
