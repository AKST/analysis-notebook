...
const { dashbox, todo, readmore, infobox, text } = prelude.components;
...
const INFOBOX = {
  effiencyVsEquity: infobox({ title: 'Effiency Vs Equity' })(
    text.p.m`
  ...
  adValoremTax: infobox({ title: 'Ad Valorem Tax' })(
    text.p.m`
...
export const taxesAndSubsidies = {
  ...
  render: (_ctx, _state) => container(
    ...
    twoThree(
      ...
      container(
        infobox({ title: "Constraint solving Equilibrium" })(
