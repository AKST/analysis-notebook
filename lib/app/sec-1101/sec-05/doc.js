...
const { dashbox, todo, readmore, infobox_2, text } = prelude.components;
...
const INFOBOX = {
  effiencyVsEquity: infobox_2({ title: 'Effiency Vs Equity' })(
    text.p.m`
  ...
  adValoremTax: infobox_2({ title: 'Ad Valorem Tax' })(
    text.p.m`
...
export const taxesAndSubsidies = {
  ...
  render: (_ctx, _state) => container(
    ...
    twoThree(
      ...
      container(
        infobox_2({ title: "Constraint solving Equilibrium" })(
