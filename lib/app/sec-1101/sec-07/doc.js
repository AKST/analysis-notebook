...
export const monopolyRegulation = {
  ...
  render: () => dashbox(
    ...
    doc.quote(doc.small(`
      ...
      cost pricing.
    `)),
    ['h3', 'Avg Cost Pricing or MC Price Ceiling?'],
    doc.small(`
...
export const priceDiscrimination = {
  ...
  render: () => dashbox(
    ...
    twoThree(
      container(
        ['h3', 'First Degree Price Discrimination (FDPD)'],
        doc.small(`
    ...
    ['h3', 'Second Degree Price Discrimination (SDPD)'],
    doc.small(`
    ...
    doc.small('SDPD tends to occur on a self selection basis.'),
    ['h3', 'Third Degree Price Discrimination (TDPD)'],
    doc.small(`
    ...
    //
    //  https://youtu.be/p6qdnr0X5u8?t=1327
    //
