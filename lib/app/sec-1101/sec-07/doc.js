...
const { dashbox, todo: docTodo, infobox, text } = prelude.components;
...
export const header = {
  ...
  render: () => container(
    ...
    dashbox(
      ...
      twoColumns(
        doc.dl([
          ['Price-setter/marker', [doc.span`When a firm has the ability to set its own prices`]],
          ['Market Power', [doc.span`When a firm has the ability to be a price-setter`]],
          ['Monopoly', [doc.span`
        ...
        doc.dl([
          ['Monopolisitic Competition', [doc.span`
          ...
          `]],
          ['Oligopolistic Competition', [doc.span`
    ...
    twoColumns(
      doc.dl([
        ['Control over scarce resource',
          [doc.span`oil, diamonds, trade routes`]
        ],
        ['Government created barriers to entry',
          [doc.span`parents, copyright`],
        ],
      ]),
      doc.dl([
        ['Increasing returns to scale',
          [doc.span`economies of scale, such as utilties`],
        ],
        ['Network economies',
          [doc.span`iMessage, Facebook`],
        ],
      ]),
    )
  ),
