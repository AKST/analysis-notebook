...
import { todo as docTodo, infobox } from '../common/components.js';
  ...
  render: () => container(
    ...
    twoColumns(
      container(
        ...
        doc.ul([
          ['Consumers & producers are price-takers.'],
          ['Homogenous goods.'],
          ['No externalities.'],
    ...
    twoColumns(
      doc.dl([
        ['Price-setter/marker', 'TODO'],
        ['Market Power', 'TODO'],
        ['Monopoly', 'TODO'],
      ]),
      doc.dl([
        ['Monopolisitic Competition', 'TODO'],
        ['Oligopolistic Competition', 'TODO'],
      ]),
    ),
    twoColumns(
      container(
