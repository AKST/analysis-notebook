...
const { infobox_2 } = prelude.components;
...
export const intro = {
    ...
    render: (_ctx, _state) => container(
      ...
      ['div', { className: 'c2 twoThree' }, [
        ...
        infobox_2({ title: 'Reservation Price' })(
          doc.p`
...
export const kindsOfCosts = {
  ...
  render: (_ctx, state, cfg) => container(
    ['div', { className: 'c2 twoThree' }, [
      ...
      container(
        infobox_2({ title: 'Cost Benefit Principle' })(
          text.p.m`
        ...
        infobox_2({ title: 'Economic Surplus' })(
          text.p.m`
...
export const elascity = {
  ...
  render: (_ctx, state, cfg) => common.dashbox(
    ...
    ['div', { className: 'c2 twoThree' }, [
      ...
      container(
        infobox_2({ title: 'Elasticity Formular' })(
          container(
            text.p.m`
...
export const deriveAtcAndAvcFromMC = {
  ...
  render: (_ctx, state, cfg) => common.dashbox(
    ...
    twoThree(
      ...
      infobox_2({ title: 'Derive Parital ATC & AVC' })(
