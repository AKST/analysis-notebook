...
export const elascity = {
  ...
  render: (_ctx, state, cfg) => common.dashbox(
    ...
    ['div', { className: 'c2' }, [
      ...
      container(
        doc.dl([
          ['Short run shut down condition', [doc.p`
            The Entrepreneur should shut down
            production if Profit < -FC
            (of Price < min AVC).
          `]],
          ['Long run shut down condition', [doc.p`
    ...
    ['div', { className: 'c2 twoThree' }, [
      container(
        ...
        doc.dl([
          ['Availablity of raw materials', [doc.p`
          ...
          `]],
          ['Inventory/Excess Capacity', [doc.p`
