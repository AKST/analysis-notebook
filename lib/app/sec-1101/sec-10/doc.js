...
export const aggregatingDemandForPublicGoods = {
  ...
  render: () => container(
    twoThree(
      dashbox(
        ['h2', 'Aggregating Demand for Public Goods'],
        doc.small(`
        ...
        `),
        doc.quote(doc.small(`
          The aggregate demand curve for a public good
          is constructed by adding all consumers’
          reservation prices (or individual marginal
          benefits) for each quantity.
        `)),
        ['h4', 'Samuelson Condition'],
        doc.small(`
...
export const marketFailure = {
  ...
  render: () => container(
    dashbox(
      twoThree(
        container(
          ['h2', 'Public Goods and Market Failure'],
          doc.small(`
      ...
      twoThree(
        container(
          ['h3', 'Government Intervention Remedies'],
          doc.small(`
        ...
        infobox('Fairness in Taxation', [
          container(
            ...
            ['ul', { className: 'no-item-padding' }, [
              ['li', 'Their ability pay?'],
              ['li', 'Their consumption of the good?'],
            ]],
          ),
        ]),
      ),
