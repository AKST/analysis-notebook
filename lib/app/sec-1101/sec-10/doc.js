...
const INFOBOX = {
  enclosure: infobox_2({ title: 'Enclosure' })(
    text.p.m`
  ...
  verticalSummation: infobox_2({ title: 'Vertical Summation' })(
    text.p.m`
  ...
  lindhalPrice: infobox_2({ title: 'Lindhal Price' })(
    text.p.m`
  ...
  render: () => container(
    dashbox(
      twoThree(
        ...
        infobox_2({ title: 'Examples of Public Goods' })(
          text.p.m`
      ...
      twoThree(
        ...
        infobox_2({ title: 'Fairness in Taxation' })(
          container(
            text.p.m`
