...
const INFOBOXES = {
  supermarketEnquiry: infobox('2024-25 Supermarket Enquiry', [
    doc.p(IMAGES.supermarketEnquiry, `
...
export const entryGame = {
  ...
  render: (_ctx) => container(
    twoThree(
      dashbox(
        ['h2', 'Existing Oligpolies in Australia'],
        doc.small`
