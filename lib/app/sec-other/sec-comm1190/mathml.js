...
export const rSquared = mathml2.math(mrow(
  over(mtext`R Squared`, sup(mi`R`, n(2))), mo`=`,
...
export const hedonicRegression = mathml2.math(rows(
  under(mrow(
    ...
    over(mtext`Difference in Difference`, over(mo`⏞`, mrow(
      sub(EST_BETA, n(3)),
