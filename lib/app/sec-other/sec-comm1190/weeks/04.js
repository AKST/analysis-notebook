...
export function render() {
  return ['details', { name: 'week', className: 'dashbox' }, [
    ['summary', { className: 'h2' }, [['h2', 'Week 4 — Predictive Analytics, Part 1']]],
    container(
      ['h3', 'An Introduction'],
      ul(
      ...
      ['h3', 'Examples of uses of Predictive models'],
      ul(
      ...
      math.modelFit,
      math.rSquared,
      ['h3', 'Professional reporting of results'],
      ul(
