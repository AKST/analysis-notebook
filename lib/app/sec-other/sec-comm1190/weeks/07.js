...
export function render() {
  return ['details', { name: 'week', className: 'dashbox' }, [
    ['summary', { className: 'h2' }, [['h2', 'Week 7 — Predictive Analytics, Part 3']]],
    container(
      container(
        ['h3', 'Classification'],
        doc.p(`
      ...
      ['hr'],
      container(
        ['h3', 'Evaluation classification models'],
      ...
      container(
        ...
        ['h4', 'Questions'],
        doc.dl([
          ['Do solutions lie with improved algorithms?', [container(
            ul(
          ...
          ['Does bias in imply bias out?', [container(
            ul(
          ...
          ['Should algorithm be blinded?', [container(
            ul(
          ...
          ['Should algorithm be interpretable?', [container(
            ul(
