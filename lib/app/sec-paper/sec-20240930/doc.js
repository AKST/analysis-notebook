...
export const intro = createDoc(() => container(
  twoThree(
    doc.h1`
      Homelessness${doc.br()}
      ${doc.small({ style: 'font-size: 14px' }).c(doc.address`
  ...
  twoThree(
    container(
      ...
      twoColumns(
        ...
        text.ul({ style: '--fontsize-body-m: 11px' }).c(
          doc.li`
            Assume economy is open and keep the factors
            prices ${text.b`w`} and ${text.b`r`} constant.
          `,
          doc.li`
...
export const calibrationTable = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'calibration' }).c(
      doc.tr(
        doc.th`Parameter`,
        doc.th`Description`,
        doc.th`Value`,
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-style: italic' }).t`Preferences`,
      ),
      doc.tr(
        doc.td`β`,
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-style: italic' }).t`Gov policy parameters`,
      ),
      doc.tr(
        doc.td`ζ${doc.sub`di`}`,
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-style: italic' }).t`Others`,
      ),
      doc.tr(
      ...
      doc.tr(
        doc.th({ style: 'text-align: left' }).t`Targeted moments →associated parameters`,
        doc.th`Data`,
        doc.th`Model`,
      ),
      doc.tr(
...
export const table2 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`Counterfactual: Shocks`,
      ),
      doc.tr(
...
export const table3 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      doc.tr(
        doc.th``,
        doc.th({ colSpan: 2 }).t`Housing demand`,
      ),
      doc.tr(
        doc.th``,
      ...
      doc.tr(
        doc.td({ style: 'padding-left: 2em' }).t`Hanushek and Quigley (1980)`,
        doc.td``,
        doc.td`-0.64; -0.45`,
      ),
      doc.tr(
        doc.td({ style: 'padding-left: 2em' }).t`Albouy et al (2016)`,
        doc.td`2/3`,
        doc.td`-2/3`,
      ),
    ),
...
export const table4 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      doc.tr(
        doc.th``,
        doc.th({ colSpan: 2 }).t`Homelessness`,
        doc.th`Housing size`,
      ...
      doc.tr(
        doc.th({ colSpan: 5, style: 'text-align: left; font-weight: bold' }).t`RCT Studies`,
      ),
      doc.tr(
...
export const table5 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`Removing housing voucher`,
      ),
      doc.tr(
        doc.td`PE`,
        doc.td`+36%`,
...
export const table6 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`Increase the frac of voucher recipients`,
      ),
      doc.tr(
        doc.td`PE`,
        doc.td`−7%`,
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`Increase voucher amount`,
      ),
      doc.tr(
        doc.td`PE`,
        doc.td`-1%`,
...
export const table7 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`Rent Subsidy on ${vars.h1}`,
      ),
      doc.tr(
        doc.td`PE`,
        doc.td`−41%`,
...
export const table9 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 2, style: 'text-align: left; font-weight: bold' }).t`Increased housing supply`,
      ),
      doc.tr(
        doc.td`${vars.h1}`,
        doc.td`−16%`,
...
export const table10 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`Counterfactual: faster recovery`,
      ),
      doc.tr(
...
export const table11 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold ' }).t`Reforms in the Benchmark`,
      ),
      doc.tr(
        doc.td`Increase the frac of voucher recipients`,
        doc.td`−15%`,
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`With low supply elasticity of ${vars.h1}(×0.5)`,
      ),
      doc.tr(
        doc.td`Increase the frac of voucher recipients`,
        doc.td`−15%`,
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`High supply elasticity of ${vars.h1}(×2)`,
      ),
      doc.tr(
        doc.td`Increase the frac of voucher recipients`,
        doc.td`−13%`,
...
export const table12 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3, style: 'text-align: left; font-weight: bold' }).t`Reforms in the model with finer housing grids`,
      ),
      doc.tr(
        doc.td`Increase the frac of voucher recipients`,
        doc.td`−13%`,
...
const vars = {
  h1: text.b`h${doc.sub`1`}`,
  h2: text.b`h${doc.sub`2`}`,
  ct: text.b`c${doc.sub`t`}`,
  ht: text.b`h${doc.sub`t`}`,
  lt: text.b`l${doc.sub`t`}`,
  wt: text.b`w${doc.sub`t`}`,
  yt: text.b`y${doc.sub`t`}`,
  zt: text.b`z${doc.sub`t`}`,
  mut: text.b`𝜇${doc.sub`t`}`,
  upsilont: text.b`ν${doc.sub`t`}`,
  phit: text.b`𝜙${doc.sub`l`}`,
  smallestH: text.b`ẖ${doc.sup`o`}`,
  govtShelter: text.b`ẖ`,
};
