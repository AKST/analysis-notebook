...
export const intro = createDoc(() => container(
  twoThree(
    doc.h1`
      Homelessness${doc.br()}
      ${doc.small.css({ fontSize: '14px' }).c(doc.address`
  ...
  twoThree(
    container(
      ...
      twoColumns(
        ...
        text.ul.cssVar({ '--fontsize-body-m': '11px' }).c(
          doc.li`
...
export const calibrationTable = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'calibration' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontStyle: 'italic' }).t`Preferences`,
      ),
      doc.tr(
        doc.td`β`,
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontStyle: 'italic' }).t`Gov policy parameters`,
      ),
      doc.tr(
        doc.td`ζ${doc.sub`di`}`,
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontStyle: 'italic' }).t`Others`,
      ),
      doc.tr(
      ...
      doc.tr(
        doc.th.css({ textAlign: 'left' }).t`Targeted moments →associated parameters`,
        doc.th`Data`,
        doc.th`Model`,
      ),
      doc.tr(
...
export const table2 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Counterfactual: Shocks`,
      ),
      doc.tr(
...
export const table3 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.td.css({ paddingLeft: '2em' }).t`Hanushek and Quigley (1980)`,
        doc.td``,
        doc.td`-0.64; -0.45`,
      ),
      doc.tr(
        doc.td.css({ paddingLeft: '2em' }).t`Albouy et al (2016)`,
        doc.td`2/3`,
        doc.td`-2/3`,
      ),
    ),
...
export const table4 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 5 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`RCT Studies`,
      ),
      doc.tr(
...
export const table5 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Removing housing voucher`,
      ),
      doc.tr(
        doc.td`PE`,
        doc.td`+36%`,
...
export const table6 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Increase the frac of voucher recipients`,
      ),
      doc.tr(
        doc.td`PE`,
        doc.td`−7%`,
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Increase voucher amount`,
      ),
      doc.tr(
        doc.td`PE`,
        doc.td`-1%`,
...
export const table7 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Rent Subsidy on ${vars.h1}`,
      ),
      doc.tr(
        doc.td`PE`,
        doc.td`−41%`,
...
export const table9 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 2 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Increased housing supply`,
      ),
      doc.tr(
        doc.td`${vars.h1}`,
        doc.td`−16%`,
...
export const table10 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Counterfactual: faster recovery`,
      ),
      doc.tr(
...
export const table11 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Reforms in the Benchmark`,
      ),
      doc.tr(
        doc.td`Increase the frac of voucher recipients`,
        doc.td`−15%`,
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`With low supply elasticity of ${vars.h1}(×0.5)`,
      ),
      doc.tr(
        doc.td`Increase the frac of voucher recipients`,
        doc.td`−15%`,
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`High supply elasticity of ${vars.h1}(×2)`,
      ),
      doc.tr(
        doc.td`Increase the frac of voucher recipients`,
        doc.td`−13%`,
...
export const table12 = createDoc(() => container(
  ...
  dashbox(
    doc.table({ className: 'results' }).c(
      ...
      doc.tr(
        doc.th({ colSpan: 3 }).css({ textAlign: 'left', fontWeight: 'bold' }).t`Reforms in the model with finer housing grids`,
      ),
      doc.tr(
        doc.td`Increase the frac of voucher recipients`,
        doc.td`−13%`,
