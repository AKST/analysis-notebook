...
const { text, clsRef, infobox, dashbox, note, noteOn, todo } = prelude.components;
...
export const supplyAndDemand = createDoc(() => dashbox(
  ...
  twoColumns(
    text.ul.compact.of(
      doc.li`${doc.b`The Labour demand curve`}${text.ul.compact.of(
      ...
      doc.li`${doc.b`The Labour supply curve`}${text.ul.compact.of(
    ...
    text.ul.compact.of(
      doc.li`${doc.b`The X axis`}${text.ul.compact.of(
        doc.li`Units of labour provided by workers`,
      )}`,
      doc.li`${doc.b`The Y axis`}${text.ul.compact.of(
        doc.li`Units of wages offered by employers`,
      )}`,
      doc.li`${doc.b`Equilibrium`} this represents${text.ul.compact.of(
