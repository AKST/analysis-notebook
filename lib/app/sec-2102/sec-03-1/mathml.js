...
export const unemploymentRate = doc._figure(
  mathml([
...
export const actualUnemployment = doc._figure(
  mathml([
...
export const bathtubModel = {
  ...
  solveForUnemployment: doc._figure(
    mathml([
      table([
        [n(0), o('='), minus(
          mul2(i('s'), sub(i('E'), i('t'))),
...
export const valueOfHumanCapital = {
  presentDiscountedRate: doc._figure(
    mathml([
  ...
  presentDiscountedValueOfSalary: doc._figure(
    mathml([
      eq(
        text('PDV'),
        mul2(
