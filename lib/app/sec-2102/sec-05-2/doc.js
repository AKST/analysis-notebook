...
const { clsRef, infobox, text, dashbox, todo } = prelude.components;
...
const LINKS = {
  ...
  jstor: {
    consumersReactingToChangesInIncome: doc.a({ href: 'https://www.jstor.org/stable/3132183' }),
    investmentBehaviour: doc.a({ href: 'https://www.jstor.org/stable/1812110' }),
  },
};
  ...
  twoThree(
    ...
    infobox('Resources', [
      text.ul.compact.of(
        ...
        doc.li`${LINKS.wiki.islmCurve`IS-LM Model`}`,
      )
    ]),
  ),
));
...
export const settingUpTheEconomony = createDoc(() => container(
  ...
  dashbox(
    ...
    `,
    text.ul.compact.of(
      doc.li`Why is ${vars.ac} constant?${text.ul.compact.of(
      ...
      doc.li`Why are the rest of multipliers constant?${text.ul.compact.of(
  ...
  dashbox(
    text.ul.compact.of(
      doc.li`About ${vars.ai}?${text.ul.compact.of(
        doc.li`
      ...
      doc.li`What is ${vars.b}?${text.ul.compact.of(
...
export const microfoundations = createDoc(() => container(
  ...
  dashbox(
    ...
    container(
      ...
      `,
      text.ul.compact.of(
        doc.li`${LINKS.wiki.pih`Permanent-Income Hypothesis`} developed by Milton Friedman`,
        doc.li`${LINKS.wiki.lch`Life-Cycle Hypothesis`} developed by Franco Modigliani`,
      ),
      doc.p`
      ...
      twoColumns(
        ...
        container(
          ...
          doc.p`
            ...
            than on income at any given age. ${doc.b`As someones income
      ...
      doc.p`
        ...
        ${doc.b`How accurate is it in practise`}? The evidence is mixed.
        See ${LINKS.jstor.consumersReactingToChangesInIncome`this study`},
    ...
    container(
      ...
      doc.p`
        ...
        consumption equation like ${doc.b`above`}. This
        phenomenon is called the ${doc.b`multiplier`}. ${doc.u`In
        an effort to simulate responses to short term changes`},
        the new term is a multiplier on the ${doc.b`output gap`},
        since it's a value between 1 & 0 it is a ${doc.b`propotion of
        the output gap`}.
      `,
      doc.quote`
        ${doc.b`Note`} the implication of this multiplier is
    ...
    container(
      ...
      doc.p`
        ...
        ${doc.b`coporate income taxes`}, ${doc.b`investment tax
        credits`}, and ${doc.b`depreciation allowances`}.
        You can read more ${LINKS.jstor.investmentBehaviour`here`}.
      `,
      doc.p`
        ...
        forced to borrow in financial markets. ${doc.b`It is more
      ...
      doc.ul.of(
        doc.li`
          ${doc.b`Adverse Selection`}: When a firm knows it may be in
        ...
        `,
        doc.li`
          ${doc.b`Moral Hazard`}: Alternatively after a firm borrows
    ...
    container(
      ...
      `,
      doc.p`
        ${doc.b`Some Government spending is discretionary`}, and this can
