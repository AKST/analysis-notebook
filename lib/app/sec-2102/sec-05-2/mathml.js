...
const { space, frac } = mathml;

const { mi, mo, mtext, mrow, mn, msub } = mathml2;
    ...
    mathml2.math(
      eq(
        mrow(
          ...
          space(4), mo`-`, space(4), mn(1)
        ),
        mrow(
          annotationUnder.attr({ label: mi`ā` })(
            msub(mi`ā`, mi`c`), space(4),
            mo`+`, space(4), msub(mi`ā`, mi`i`), space(4),
            mo`+`, space(4), msub(mi`ā`, mi`g`), space(4),
            mo`+`, space(4), msub(mi`ā`, mi`ex`), space(4),
            mo`-`, space(4), msub(mi`ā`, mi`im`), space(4),
            mo`-`, space(4), mn(1),
          ),
          space(4), mo`-`, space(4),
          mul2(mi`b̄`, minusP(msub(mi`R`, mi`t`), mi`r̄`))
