...
export const moneyTransmission = doc._figure(
  mathml([
    o('↑'),
...
export const outputGap = doc._figure(
  mathml([
    eq(
      sub(i('Ỹ'), i('t')),
      minus(
...
export const consumptionShare = doc._figure(
  mathml([
    eq(
...
export const ISCurve = doc._figure(
  mathml([
    eq(
      sub(i('Ỹ'), i('t')),
      mul2(
...
export const investmentLevel = doc._figure(
  mathml([
    eq(
      sub(i('I'), i('t')),
      minus(
