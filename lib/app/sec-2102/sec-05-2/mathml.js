...
const { mi, mo, mtext, mrow, mn, msub, mspace, mfrac } = mathml2;
const { eq, add, SPECIAL, annotationUnder } = mathmlHelper_2;
const { add3, mul2, eqId, minus, minusP, mul3 } = mathmlHelper;
const { rel } = SPECIAL;
