...
export const gdpExpenditure = {
  output: doc.figure(
    ...
    'Expenditure approach to GDP: Yₜ = Cₜ + Iₜ + Gₜ + EXₜ − IMₜ'
  ),
  consumption: doc.figure(
    ...
    'Consumption as a proportion of potential output'
  ),
  government: doc.figure(
    ...
    'Government spending proportional to potential output'
  ),
  exports: doc.figure(
    mathml([
      eq(
    ...
    'Exports as a proportion of potential output'
  ),
  imports: doc.figure(
    mathml([
      eq(
    ...
    'Imports as a proportion of potential output'
  ),
...
export const consumptionShare = doc.figure(
  ...
  'Consumption share: Cₜ/Yₜ = ā_c + x̄·Ỹₜ'
);
...
export const ISCurve = doc.figure(
  ...
  'IS curve with consumption response: Ỹₜ = (1 / (1 − x̄)) · [ā − b̄(Rₜ − r̄)]'
);
