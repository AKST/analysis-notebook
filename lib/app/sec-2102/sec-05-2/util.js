  ...
  return {
    ...
    isCurve: {
      ...
      of: {
        ...
        investment: { aggregate:  0.1, rateSensitivity: 0.5 },
      },
      group: {
        aggregateConsumption: nKnob({ label: 'Agg Consumption (a)' }),
        ...
        investment: {
          ...
          group: {
            ...
            rateSensitivity: nKnob({ label: 'Investment Sensetivity (b)' })
          },
        }
      },
    },
...
const IsCurve = {
  ...
  atOutputOf(longRun, isCurve, Y) {
    ...
    const b = isCurve.investment.rateSensitivity;
    return ((Y - a) / (-b)) + r;
  },
  /**
   * @param {LongRun.T} longRun
