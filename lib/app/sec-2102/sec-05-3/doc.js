...
const { text, clsRef, infobox_2, dashbox, todo } = prelude.components;
...
export const microFoundations2 = createDoc(() => container(
  ...
  dashbox(
    ...
    twoThree(
      ...
      infobox_2({ title: 'Nominal Interest in the short run' })(
        doc.p`
