  ...
  twoThree(
    ...
    infobox('Resources', [
      ulLight([
        ...
        LINKS.potenialOutput`Potential Output`,
      ])
    ]),
  ),
));
  ...
  container(
    twoThree(
      ...
      doc.quote.of(
        ...
        `,
        doc.small({ style: 'text-align: right' })`— John Maynard Keynes`,
      ),
    ),
  ),
));
...
export const theShortrunModel = createDoc(() => container(
  ...
  dashbox(
    doc.small`The short run mode is based on three premises.`,
    doc.ol({ className: 'no-item-padding' }).of(
      doc.li.of(doc.small`
  ...
  dashbox(
    doc.ul.of(
      ...
      `),
      doc.li.of(
        doc.small`In a ${doc.b`booming`} economy`,
        doc.ul({ className: 'no-item-padding' }).of(
          doc.li.of(doc.small`Say the prevailing inflation rate is 5%`),
          doc.li.of(doc.small`All firms are raising their prices by 7%`),
        ),
      ),
      doc.li.of(
        doc.small`In a ${doc.b`contracting`} economy`,
        doc.ul({ className: 'no-item-padding' }).of(
          doc.li.of(doc.small`Say the prevailing inflation rate is 5%`),
          doc.li.of(doc.small`All firms are raising their prices by 3%`),
          doc.li.of(doc.small.of(doc.i`
...
export const okunsLaw = createDoc(() => container(
  ...
  dashbox(
    ...
    `,
    doc.ul({ className: 'no-item-padding' }).of(
      doc.li.of(doc.small`A recession, for example, is a time when output is below potential and unemployment is high`),
      doc.li.of(doc.small`A boom is a time when output is above potential and unemployment is low`),
    ),
    twoThree(
      doc.small`
