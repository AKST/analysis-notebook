...
const { mi, mo, mtext, mrow, mover, mn, msub, msup, msubsup, munder } = mathml2;
...
export const steadyStateWorkingout = mathml2.math(rows(
  ...
  ), mrow(mtext`divide by`, space(8), vars.capitalEEq)),
  ...
  mover(eq(
    ...
    msup(vars.capitalEq, alpha),
  ), mrow(mtext`divide by`, space(8), vars.depreciation)),
