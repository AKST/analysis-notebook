...
const { readmore, infobox, ulLight, ulLightSm, dashbox, noteOn, note, todo } = prelude.components;
...
export const strengthsAndLimitations = createDoc(() => dashbox(
  ...
  twoColumns(
    container(
      ['h4', 'Strengths'],
      ulLightSm([
        'Provides a framework for the growth of capital.',
        'Provides a means to isolate TFP via subtraction of labour and capital.',
      ]),
    ),
    container(
      ['h4', 'Limitations'],
      ulLightSm([
        'No answer to rate at which a country invests.',
        'No answer to how the steady moves.',
        'No answer to long term growth.',
      ]),
    ),
  ),
));
...
export const continousK = createDoc(() => dashbox(
  ['h2', 'Extra — Continious Capital'],
  doc.figure(mathml.continiousK, 'Captial as continuous function'),
  doc.small`
