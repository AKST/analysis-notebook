  ...
  twoThree(
    container(
      ...
      text.ul.compact.of(
        ...
        doc.li`Insights:${text.ul.compact.of(
...
export const modelSetup = createDoc(() => container(
  ...
  dashbox(
    twoColumns(
      container(
        doc._figure(mathml.temporalOutput, doc.figcaption`Output over time`),
        text.ul.compact.of(
      ...
      container(
        doc._figure(mathml.resourceConstraint, doc.figcaption`Resource Constraint`),
        text.ul.compact.of(
    ...
    twoColumns(
      container(
        doc.h4`Capital`,
        doc._figure(mathml.capitalAccumulation, doc.figcaption`Capital Dynamics`),
        text.ul.compact.of(
          doc.li`d̄ is rate of depreciation`,
          doc.li`Models Captial dynamics${text.ul.compact.of(
            doc.li`Investment undertaken during t`,
            doc.li`physical depreciation of stock`,
          )}`,
        ),
        doc._figure(mathml.capitalAccumulation2, doc.figcaption`Rewrite capital dynamics`),
        doc.p`
          With this we add capital accumulation dynamics, and in order
          to start change, initial values need to be a assumed for
          capital and investment.
        `,
        doc._figure(mathml.initialStock, doc.figcaption`Initial stock`),
      ),
      container(
        doc.h4`Labour`,
        doc._figure(mathml.exogenousLabour, doc.figcaption`Exogenous Labour`),
        text.ul.compact.of(
        ...
        doc._figure(mathml.investmentDynamics, doc.figcaption`Investment Dynamics`),
        doc._figure(mathml.consumptionDynamics, doc.figcaption`Consumption Dynamics`),
        text.ul.compact.of(
...
export const solvingTheModel = createDoc(() => dashbox(
  ...
  twoThree(
    container(
      ...
      doc._figure(mathml.solowDiagram, doc.figcaption`Solow Diagram`),
      doc.p`
    ...
    container(
      doc._figure(mathml.netInvestmentConstraint, doc.figcaption`Change Constraint`),
      doc._figure(mathml.temporalOutputWithFixedLabour, doc.figcaption`Production with fixed labour`),
  ...
  dashbox(
    twoThree(
      container(
        ...
        `,
        doc._figure(mathml.steadyStateConstraint, doc.figcaption`Steady state constraint`),
        doc._figure(mathml.solveSteadyState, doc.figcaption`Steady state of captial`),
        doc._figure(mathml.steadyStateOutput, doc.figcaption`Steady state of output`),
      ),
      doc._figure(mathml.steadyStateWorkingout, doc.figcaption`Steady State working out`),
    ),
  ),
  dashbox(
    twoThree(
      container(
        doc.h3`Per capita`,
        doc._figure(mathml.steadyStatePerWorker, doc.figcaption`Steady state per capita`),
        doc.p`
      ...
      container(
        doc._figure(mathml.steadyStatePerWorkerWorkingOut, doc.figcaption`working out`),
        doc._figure(mathml.productionPerCapita, doc.figcaption`production per capita`),
      ),
    ),
  ),
  dashbox(
    doc.h3`The Captial-Output Ratio`,
    doc._figure(mathml.outputToCapitalRatio, doc.figcaption`Output To Capital Ratio in Steady state`),
    doc.p`
...
export const continousK = createDoc(() => dashbox(
  ...
  doc._figure(mathml.continiousK, doc.figcaption`Captial as continuous function`),
  doc.p`
