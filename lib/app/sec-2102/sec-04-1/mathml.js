...
export const quantityTheoryOfInflation = doc._figure(
  mathml([
    rows([
      table([
...
export const inflationRate = doc._figure(
...
export const fisherEquation = doc._figure(
  mathml([eq(i('i'), add(i('R'), i('𝜋')))]),
  doc.figcaption`Fisher Equation`,
);

export const governmentBudgetConstraint = doc._figure(
  mathml([
    eq(
