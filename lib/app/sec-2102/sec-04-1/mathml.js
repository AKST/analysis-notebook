...
export const quantityTheoryOfInflation = doc.figure(
  mathml([
    rows([
      table([
        [sub(i('g'), i('M')), o('='), text('% change in '), text('money supply')],
        [sub(i('g'), i('V')), o('='), text('% change in '), text('velocity')],
        [sub(i('g'), i('P')), o('='), text('% change in '), text('price level')],
        [sub(i('g'), i('Y')), o('='), text('% change in '), text('real GDP')],
