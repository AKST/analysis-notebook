...
import { doc, mathml2 } from '../../prelude.js';
import { mathmlHelper, mathmlHelper_2 } from '../prelude.js';

const { mi, mo, mtext, mrow, mn, msub, msubsup, msup, mspace, mfrac } = mathml2;
const { rows, annotationUnder, table } = mathmlHelper_2;
const { implies, addP, eq, eqId, mul3, mul2, add, add3, minus, minusP } = mathmlHelper;
