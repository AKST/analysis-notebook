...
export const quantityTheoryOfMoney = createDoc(() => container(
  ...
  tables.moneyTerms,
  dashbox(
    clsRef({ book: { chapter: 8, page: 218 } }, ['h3', 'Quantity Equation']),
    container(
      twoThree(
        container(
          ['h3', 'They Quantity Equation'],
          doc.small(`
    ...
    doc.small(
      'The essence of the quantity theory of money is: ',
      doc.b('in the long run'),
...
export const costOfInflation = createDoc(() => dashbox(
  ...
  doc.small(`
    ...
    $4000 in 1970 by the year 1983. This can happen with fixed
