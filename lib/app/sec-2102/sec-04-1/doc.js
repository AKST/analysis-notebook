...
export const quantityTheoryOfMoney = createDoc(() => container(
  ...
  dashbox(
    ...
    note(
      doc.span`Todays money is fiat money${text.ul.compact.of(
      ...
      doc.span`Dollarsiation${text.ul.compact.of(
