/**
 * @import { KnobElement, MakeOptionalKnob } from '../type.ts';
 */
import { ToggleInput } from '../../inputs/index.js';
import { updateOn } from '../../../base/render_ui/index.js';
...
export class OptionalKnob extends HTMLElement {
  ...
  connectedCallback() {
    updateOn(this.shadowRoot, [this.#child]);

    this.#child?.addEventListener('changeKnob', (e) => {
      const event = /** @type {any} */ (e);
