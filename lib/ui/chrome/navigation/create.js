 ...
 * @import { AppFeatureFlags, MenuItem } from './app-explorer/type.ts';
 * @import { NavigationController } from './type.ts';
 */
import { BasicButton } from '@ui/inputs/button.js';
import { DEFAULT_APP_ID, menuStructure } from './app-explorer/config.js';
import { AppExplorerMenu } from './app-explorer/element.js';
import { idFromHash, TableOfContentsMenu } from './table-of-contents/element.js';
