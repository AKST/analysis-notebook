...
export class UserApplicationContentElement extends HTMLElement {
  ...
  static installInplaceOfMain({
    ...
    const reset = new SharedStyleSheet(import.meta.resolve('@ui/base/reset.css'));
