...
export const menuStructure = [
  ['unsw', 'UNSW', [
    ...
    ['unsw.2206', 'ECON2206', [
      ...
      ['unsw.2206.09-2', 'Advc Panel Data'],
      ['unsw.2206.10-1', 'Instrumental Vars Est'],
      ['unsw.2206.10-2', 'Simultaneous Equations'],
      ['unsw.2206.10-3', 'Limited Dependent Vars'],
      ['unsw.2206.10-4', 'Advc Time Series'],
    ]],
  ]],
  ["debug", "Debug", [
    ["debug.1", "Std Library"],
  ...
  ["textbook", "Textbooks", [
    ["textbook.c", "Complex Analysis", [
      ["textbook.c.1", "Complex Numbers", [
        ["textbox.c.1.1", "Addition and multiplication"],
        ["textbox.c.1.2", "Binomial Equation"],
        ["textbox.c.1.3", "Analytic Geometry"],
        ["textbox.c.1.4", "Spherical Representation"]
      ]],
