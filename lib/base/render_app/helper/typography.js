...
const makeHelper = (f) => {
  ...
  const helper = function () {
    if (typeof arguments[0] === 'object' && !Array.isArray(arguments[0])) {
      // @ts-ignore - i can't be stuffed
      return (...args) => stringTemplateFunction(arguments[0], ...args);
    } else {
      // @ts-ignore - i can't be stuffed
...
/** @param {ElAttributes} [attr] @return {E.Item} */
export const hr = (attr = {}) => ['br', attr];

export const helpers = {
  a, abbr, b, br, dl, figure, font, frag,
  i, image, hr, h1, h2, h3, h4, h5, h6, li,
  p, quote, small, span, sub, sup,
  u, ul,
};
