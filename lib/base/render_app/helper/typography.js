...
import { makeHelper, makeTemplateHelper } from './util.js';
...
export const area = makeTemplateHelper((attrs, items) => ['area', attrs, items]);
export const aside = makeTemplateHelper((attrs, items) => ['aside', attrs, items]);
...
export const col = makeTemplateHelper((attrs, items) => ['col', attrs, items]);
...
export const _dl = makeTemplateHelper((attrs, items) => ['dl', attrs, items]);
export const dt = makeTemplateHelper((attrs, items) => ['dt', attrs, items]);
export const embed = makeTemplateHelper((attrs, items) => ['embed', attrs, items]);
...
export const header = makeTemplateHelper((attrs, items) => ['header', attrs, items]);
...
export const input = makeTemplateHelper((attrs, items) => ['input', attrs, items]);
...
export const source = makeTemplateHelper((attrs, items) => ['source', attrs, items]);
...
export const table = makeTemplateHelper((attrs, items) => ['table', attrs, items]);
...
export const tr = makeTemplateHelper((attrs, items) => ['tr', attrs, items]);
export const track = makeTemplateHelper((attrs, items) => ['track', attrs, items]);
...
export const helpers = {
  ...
  fieldset, figcaption, _figure: figure, font, form, footer, frag,
