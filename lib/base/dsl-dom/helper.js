...
class ElementBuilder {
  ...
  from(itemsIn) {
    ...
    const attrs = new MetaContainer({}, this.dataset, this.styles, this.stylesVar, this.attrs);
  ...
  void(attrsIn) {
    ...
    const meta = new MetaContainer({}, this.dataset, this.styles, this.stylesVar, attr);
   ...
   */
  meta({ events, dataset, styles, stylesVar, attributes }) {
  ...
  cssVar(stylesVar) {
    return this.#create({
      stylesVar: { ...this.stylesVar, ...stylesVar },
    });
  }
...
class VoidElementBuilder {
   ...
   * @param {E.Events} events
   */
  constructor(construct, attrs, dataset, styles, stylesVar, events) {
    this.#construct = construct;
    this.attrs = attrs;
    this.dataset = dataset;
    this.styles = styles;
  ...
  /**
   * @param {E.StylesVar} stylesVarIn
   */
  cssVar(stylesVarIn) {
    const stylesVar = { ...this.stylesVar, ...stylesVarIn };
    return new VoidElementBuilder(this.#construct, this.attrs, this.dataset, this.styles, stylesVar, this.events);
  }
  ...
  data(datasetIn) {
    ...
    return new VoidElementBuilder(this.#construct, this.attrs, dataset, this.styles, this.stylesVar, this.events);
  }
