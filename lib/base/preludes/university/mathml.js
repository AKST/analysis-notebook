...
const { SPECIAL, paren, frac } = mathml;
const { mrow, mn, mspace } = mathml2;

/** @param {string} v @returns {E.Item} */
const o = v => ['mo', v];

/** @param {E.Item} a @param {...E.Item} b */
export const eq = (a, ...b) => mrow(a, mspace(4), o('='), mspace(4), ...b);

/** @param {E.Item} a @param {...E.Item} b */
export const eqId = (a, ...b) => mrow(a, mspace(4), o('≡'), mspace(4), ...b);

/** @param {E.Item} a @param {E.Item} b */
export const add = (a, b) => mrow(a, mspace(4), o('+'), mspace(4), b);

/** @param {E.Item} a @param {E.Item} b */
export const div = (a, b) => mrow(a, mspace(4), o('÷'), mspace(4), b);
...
export const implies = (a, b) => mrow(
  a, mspace(12), SPECIAL.arrow, mspace(12), b
);
