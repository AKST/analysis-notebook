 ...
 * @import { Helper } from '../../dom_app/helper/type.ts';
 */
import { makeHelper, makeTemplateHelper } from '../../dom_app/helper/util.js';
import { helpers as doc } from '../../dom_app/index.js';
 ...
 */
export const infobox_2 = makeHelper(({ title, ...attrs }, body) => (
  doc.aside.attr({
    ...attrs,
    className: joinClass(attrs.className, 'infobox'),
  })(
    doc.h3({ className: "infobox-name" })`💡 ${title}`,
    doc.div({ className: "infobox-body" }).of(...body),
  )
));
