...
/**
 * @param {{ bg: string, shadow: string }} color
 */
export function horizontalShadow({ bg, shadow }) {
  return {
    backgroundColor: bg,
    backgroundImage: `
			linear-gradient(to right, ${bg}, ${bg}),
			linear-gradient(to right, ${bg}, ${bg}),
      linear-gradient(to right, color(from ${shadow} srgb r g b / 0.25), color(from ${bg} srgb r g b / 0.0)),
      linear-gradient(to left, color(from ${shadow} srgb r g b / 0.25), color(from ${bg} srgb r g b / 0.0))
    `,
    backgroundPosition: 'left center, right center, left center, right center',
    backgroundRepeat: 'no-repeat',
    backgroundSize: '32px 100%, 32px 100%, 16px 100%, 16px 100%',
...
export const getTypography = () => ({
  '> *': {
    '--fontsize-body-m': 11.5,
    '--fontsize-body-l': 13,
  },
  'p, quote, li, dd, figcaption': {
  ...
  quote: {
    ...
    fontStyle: 'italic',
    paddingLeft: 16,
    borderLeft: 'var(--border-solid-white)',
    borderLeftWidth: 4,
  ...
  ':is(summary, quote, p, dd, li, h1, h2, h3, h4, h5, h6, span) > strong': {
    textShadow: 'var(--txt-shadow-blue)',
  },
  'quote, p': {
  ...
  'math.math-prone-too-overflow': {
    fontSize: 'var(--fontsize-math-m)',
    [MOBILE_MEDIA_QUERY]: {
      fontSize: 'var(--fontsize-math-s)',
    },
  },
  figure: {
    marginLeft: 'auto',
...
export const getLayout = ({ c2 } = {}) => ({
  ...
  '.grid-responsive-row': {
    ...
    [SLIM_MEDIA_QUERY]: { gridTemplateColumns: 'var(--grid-responsive-row-slim-columns)' },
    [MOBILE_MEDIA_QUERY]: { gridTemplateColumns: 'var(--grid-responsive-row-mobile-columns)' },
    [DESKTOP_MEDIA_QUERY]: { gridTemplateColumns: 'var(--grid-responsive-row-desktop-columns)' },
  },
