...
export const b = makeTemplateHelper('html', 'b')();
...
export const em = makeVoidHelper('html', 'em')();
...
export const i = makeTemplateHelper('html', 'i')();
...
export const strong = makeTemplateHelper('html', 'strong')();
