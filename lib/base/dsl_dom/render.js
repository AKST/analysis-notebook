...
export class MetaContainer {
   ...
   * @param {E.StylesVar | undefined} stylesVar
   * @param {O} attributes
   */
  constructor(events, dataset, styles, stylesVar, attributes) {
    this.events = events;
...
export const render = /** @type {any} */ ((
  ...
  if (meta) {
    ...
    if (meta.stylesVar) {
      for (const [prop, value] of Object.entries(meta.stylesVar)) {
        const styles = /** @type {HTMLElement} */ (element).style;
...
export const update = /** @type {any} */ ((
  ...
  if (meta) {
    ...
    if (meta.styles) {
      ...
      for (const [rule, value] of Object.entries(meta.styles)) {
        if (styles[rule] !== value) styles[rule] = value;
      }
    }
    ...
    if (meta.attributes) {
      ...
      for (const [key, val] of Object.entries(meta.attributes)) {
        ...
        if (val == currVal) continue; // this is absolutely intentional
