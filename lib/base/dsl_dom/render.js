...
export class RenderNode {
  ...
  /** @type {NS} */ ns;
  /** @type {T} */ tagName;
  /** @type {E.Meta<O> | undefined} */ attributes
  /** @type {readonly E.Item[] | undefined} */ children

  /**
   * @param {NS} ns
   * @param {T} tagName
   * @param {E.Meta<O> | undefined} attributes
 ...
 * @template {Element} E
 * @param {E} elem
 * @param {E.Meta<Partial<E>>} [attributes]
 * @param {E.Item[]} [children]
 * @return {E.Insert<E>}
 */
 ...
 * @param {NS} ns
 * @param {T} tagName
 * @param {E.Meta<Partial<ElementAttributesWriteOnly<NS, T>>>} [attributes]
 * @param {E.Item[]} [children]
