...
export class MetaBuilder {
  ...
  /**
   * @param {E.StylesVar} props
   * @returns {MetaBuilder<O>}
   */
  styleProp(props) {
    this.meta = styleProperties(this.meta, props);
    return this;
  }
}
 ...
 * @template {keyof O} K
 * @param {E.Meta<O>} meta
 * @param {E.StylesVar} styleVarUpdate
 */
export function styleProperties(meta, styleVarUpdate) {
  return new MetaContainer(
    meta.events,
    meta.dataset,
    meta.styles,
    { ...meta.stylesVar, ...styleVarUpdate },
    meta.attributes,
  );
}
