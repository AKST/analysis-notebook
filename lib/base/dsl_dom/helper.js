...
class ElementBuilder {
  ...
  of(...itemsIn) {
    ...
    const attrs = new AttributeContainer({}, this.dataset, this.styles, this.attrs);
...
class VoidElementBuilder {
   ...
   * @param {E.Styles} styles
   */
  constructor(construct, defAttrs, dataset, styles) {
    this.#construct = construct;
    this.attrs = defAttrs;
    this.dataset = dataset;
    this.styles = styles;
   ...
   */
  attr(attrsIn) {
    const attrs = new AttributeContainer({}, this.dataset, this.styles, attrsIn);
   ...
   */
  attrAdd(attrsIn) {
    return new VoidElementBuilder(this.#construct, this.#updateAttrs(attrsIn), this.dataset, this.styles);
  }
  ...
  css(stylesIn) {
    ...
    return new VoidElementBuilder(this.#construct, this.attrs, this.dataset, styles);
  }
  ...
  data(datasetIn) {
    ...
    return new VoidElementBuilder(this.#construct, this.attrs, dataset, this.styles);
  }
