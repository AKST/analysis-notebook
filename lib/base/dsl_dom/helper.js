...
class ElementBuilder {
  ...
  of(...itemsIn) {
    ...
    const attrs = new AttributeContainer({}, {}, this.styles, this.attrs);
...
class VoidElementBuilder {
   ...
   * @param {E.Styles} styles
   */
  constructor(construct, defAttrs, styles) {
    this.#construct = construct;
    this.attrs = defAttrs;
    this.styles = styles;
  }
   ...
   */
  attr(attrsIn) {
    const attrs = new AttributeContainer({}, {}, this.styles, attrsIn);
   ...
   */
  attrAdd(attrsIn) {
    return new VoidElementBuilder(this.#construct, this.#updateAttrs(attrsIn), this.styles);
  }
  ...
  css(stylesIn) {
    ...
    return new VoidElementBuilder(this.#construct, this.attrs, styles);
  }
