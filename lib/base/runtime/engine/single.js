...
class SingleWidgetApplicationEngine {
  ...
  renderOn(kind, event) {
    if (kind === 'any') {
      this.#widget.render(this.configValues, this.state, event);
