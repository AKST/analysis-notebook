...
export const caption = makeTemplateHelper((attrs, items) => ['caption', attrs, items]);
...
export const dfn = makeTemplateHelper((attrs, items) => ['dfn', attrs, items])
...
export const em = makeTemplateHelper((attrs, body) => ['em', attrs, body]);
...
export const strong = makeTemplateHelper((attrs, body) => ['strong', attrs, body]);
...
export const helpers = {
  a, abbr, address, area, aside, article, audio, button, bdi,
  ...
  kbd, iframe, img, ins, input, header, hgroup, hr,
  ...
  small, slot, source, span, strong, sub, summary, sup, table, template,
