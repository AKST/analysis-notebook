...
import { html as doc } from '@base/dom_app/index.js';
...
export function marketCrossSection_2({
  ...
  const colSpan = (1 + keysAll.length + keysWithoutBase.length).toString();
  ...
  return doc.table({ className: 'common-market-surplus-table' }).of(
    doc.tr(
      doc.th``,
