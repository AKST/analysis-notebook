 ...
 */
import { makeHelper, makeTemplateHelper } from '@base/dsl-dom/helper.js';
import * as doc from '@base/dsl-dom/helper/html.js';
import * as Meta from '@base/dsl-dom/node-meta.js';
import { node } from '@base/dsl-dom/render.js';
...
/**
 * @param {string} topic
 * @returns {(...content: E.Node<'html', 'li', unknown>[]) => E.Node<'html', 'p', unknown>}
 */
 ...
 * }} cfg
 * @returns {E.Node<'html', 'table', unknown>}
 */
