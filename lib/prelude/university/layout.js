...
export const container = (...items) =>
  doc.div({ className: 'container pre--container' }).of(...items);
...
export const twoColumns = (a, b) =>
  doc.div({ className: 'c2 pre--c2' }).of(a, b);
...
export const twoThree = (a, b) =>
  doc.div({ className: 'c2 twoThree pre--c2 pre--two-three' }).of(a, b);
...
export const fontsize = (body, f) =>
  doc.div({ style: `font-size: ${f}px` }).of(body);
